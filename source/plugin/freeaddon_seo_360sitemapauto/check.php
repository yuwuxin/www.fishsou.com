...
if($operation == 'import' && empty($license)){
	$license = dfsockopen('http://addon.1314study.com/api/license.php?siteurl='.rawurlencode($_G['siteurl']).'&identifier='.$identifier, 0, '', '', false, '', 5);$cachevalue['license'] = 1;savecache($cachekey, $cachevalue);
