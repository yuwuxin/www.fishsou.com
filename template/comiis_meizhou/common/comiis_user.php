...
<!--{elseif !$_G[connectguest]}-->
	<!--{if ($comiis_header==1 && $_G['basescript']=='portal') || $comiis_header==3}--><span class="kmtwzx"><span>欢迎您，请&nbsp;<a onclick="showWindow('login', this.href);return false;" href="member.php?mod=logging&action=login">登录</a>&nbsp;或&nbsp;<a href="member.php?mod={$_G[setting][regname]}">$_G['setting']['reglinkname']</a></span></span><!--{else}--><!--{template member/comiis_login}--><!--{/if}-->
<!--{else}-->
