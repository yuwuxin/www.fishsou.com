...
<div class="comiis_footer">
	...
	Copyright &copy; 2014-2020 <a href="$_G['setting']['siteurl']" rel="nofollow" target="_blank">$_G['setting']['sitename']</a> <a href="$_G['setting']['siteurl']" rel="nofollow" target="_blank">$_G['setting']['siteurl']</a> 版权所有 All Rights Reserved.<br />
	免责声明: 本网不承担任何由内容提供商提供的信息所引起的争议和法律责任。<br />
	搜鱼网 $_G['setting']['version']&nbsp;技术支持:Voyage
	<!--{if $_G['setting']['site_qq']}--><a href="http://wpa.qq.com/msgrd?v=3&uin=1943759704&site=qq&menu=yes" target="_blank" title="QQ"><img src="{IMGDIR}/site_qq.jpg" alt="QQ" /></a><!--{/if}-->
	</div>
	<p>
...
<div id="ft" class="wp cl zdvg">
	...
	<div id="frt">
		<p>Powered by <strong><a href="#" target="_blank">源码网</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="#" target="_blank">Licensed</a><!--{/if}--></p>
