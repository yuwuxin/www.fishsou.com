...
<!--{/if}-->
<!--{if $comiis_forum_ng==1}-->
<div class="wp comiis_bbsbox">
	<div class="comiis_bbsbox_z">
		<!--[diy=comiis_bbsbox_swf]--><div id="comiis_bbsbox_swf" class="area"></div><!--[/diy]-->
	</div>
	<div class="comiis_bbsbox_y">
		...
		<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_1">
			<!--[diy=comiis_bbsbox_01]--><div id="comiis_bbsbox_01" class="area"></div><!--[/diy]-->
		</div>
		<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_2" style="display:none">
			<!--[diy=comiis_bbsbox_02]--><div id="comiis_bbsbox_02" class="area"></div><!--[/diy]-->
		</div>
		<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_3" style="display:none">
			<!--[diy=comiis_bbsbox_03]--><div id="comiis_bbsbox_03" class="area"></div><!--[/diy]-->
		</div>
		<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_4" style="display:none">
			<!--[diy=comiis_bbsbox_04]--><div id="comiis_bbsbox_04" class="area"></div><!--[/diy]-->
		</div>
		<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_5" style="display:none">
			<!--[diy=comiis_bbsbox_05]--><div id="comiis_bbsbox_05" class="area"></div><!--[/diy]-->
		</div>
	</div>
</div>
	...
	<!--{if empty($gid)}-->
		<div id="chart" class="bm bw0 cl">
			...
			<div class="y comiis_chart_btn">
				...
				<!--{if !empty($_G['setting']['search']['forum']['status'])}--><a href="forum.php?mod=guide&view=new" title="{lang show_newthreads}">{lang show_newthreads}</a><!--{/if}-->
		...
		<div class="fl bm">
			<div class="bm bmw cl">
				<div id="category_grid" class="bm_c" >
					...
					<!--{if !$_G['setting']['grid']['gridtype']}-->
						<td valign="top" class="category_l1">
							<div class="newimgbox">
								...
								<div class="module cl slidebox_grid" style="width:<!--{if $comiis_window_width==1}-->275px<!--{else}-->225px<!--{/if}-->">
									<script type="text/javascript">
									var slideSpeed = 5000;
									var slideImgsize = [<!--{if $comiis_window_width==1}-->275<!--{else}-->225<!--{/if}-->,235];
					...
					<td valign="top" class="category_l3<!--{if !$_G['setting']['grid']['gridtype']}--> category_l3hot<!--{/if}-->">
						<div class="hottiebox">
