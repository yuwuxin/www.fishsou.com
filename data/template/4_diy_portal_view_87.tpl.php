<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_87');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_87.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527846026, 'diy', './data/template/4_diy_portal_view_87.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_87')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_87.htm', './template/default/common/seccheck.htm', 1527846026, 'diy', './data/template/4_diy_portal_view_87.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_87')
;
block_get('3350,3353,3351,3342,3343,3344,3345,3346,3347,3348,3349,3352');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framesXBW5m" class="frame move-span cl frame-1"><div id="framesXBW5m_left" class="column frame-1-c"><div id="framesXBW5m_left_temp" class="move-span temp"></div></div></div><div id="framemRvfL7" class="cl_frame_bm frame move-span cl frame-1"><div id="framemRvfL7_left" class="column frame-1-c"><div id="framemRvfL7_left_temp" class="move-span temp"></div><?php block_display('3350');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3343 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3345 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3347 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3350 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameyzqvNI {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameGOHYvm" class="frame move-span cl frame-1"><div id="frameGOHYvm_left" class="column frame-1-c"><div id="frameGOHYvm_left_temp" class="move-span temp"></div><?php block_display('3353');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameyzqvNI" class=" frame move-span cl frame-1"><div id="frameyzqvNI_left" class="column frame-1-c"><div id="frameyzqvNI_left_temp" class="move-span temp"></div><?php block_display('3351');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framerpAr7V" class="cl_frame_bm frame move-span cl frame-1"><div id="framerpAr7V_left" class="column frame-1-c"><div id="framerpAr7V_left_temp" class="move-span temp"></div><?php block_display('3342');?><?php block_display('3343');?><?php block_display('3344');?><?php block_display('3345');?><?php block_display('3346');?><?php block_display('3347');?><?php block_display('3348');?><?php block_display('3349');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameS2M9gW" class="frame move-span cl frame-1"><div id="frameS2M9gW_left" class="column frame-1-c"><div id="frameS2M9gW_left_temp" class="move-span temp"></div><?php block_display('3352');?></div></div></div><!--[/diy]-->
</div>
