<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_19');
block_get('3137,3134,3135,3126,3127,3128,3129,3130,3131,3132,3133,3136');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameR5klfk" class="frame move-span cl frame-1"><div id="frameR5klfk_left" class="column frame-1-c"><div id="frameR5klfk_left_temp" class="move-span temp"></div><?php block_display('3137');?></div></div><div id="frameMlpD7N" class="frame move-span cl frame-1"><div id="frameMlpD7N_left" class="column frame-1-c"><div id="frameMlpD7N_left_temp" class="move-span temp"></div></div></div><div id="framedzyZXz" class="cl_frame_bm frame move-span cl frame-1"><div id="framedzyZXz_left" class="column frame-1-c"><div id="framedzyZXz_left_temp" class="move-span temp"></div><?php block_display('3134');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3127 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3129 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3131 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3134 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameQ0Y0Hz {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameQ0Y0Hz" class=" frame move-span cl frame-1"><div id="frameQ0Y0Hz_left" class="column frame-1-c"><div id="frameQ0Y0Hz_left_temp" class="move-span temp"></div><?php block_display('3135');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameoX7EEf" class="cl_frame_bm frame move-span cl frame-1"><div id="frameoX7EEf_left" class="column frame-1-c"><div id="frameoX7EEf_left_temp" class="move-span temp"></div><?php block_display('3126');?><?php block_display('3127');?><?php block_display('3128');?><?php block_display('3129');?><?php block_display('3130');?><?php block_display('3131');?><?php block_display('3132');?><?php block_display('3133');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framefGmk5f" class="frame move-span cl frame-1"><div id="framefGmk5f_left" class="column frame-1-c"><div id="framefGmk5f_left_temp" class="move-span temp"></div><?php block_display('3136');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
