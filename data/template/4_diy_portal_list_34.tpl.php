<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_34');
block_get('2462,2465,2463,2454,2455,2456,2457,2458,2459,2460,2461,2464');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framefvc8BT" class="cl_frame_bm frame move-span cl frame-1"><div id="framefvc8BT_left" class="column frame-1-c"><div id="framefvc8BT_left_temp" class="move-span temp"></div><?php block_display('2462');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2455 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2457 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2459 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2462 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framefw2Jk0 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameJboV0z" class="frame move-span cl frame-1"><div id="frameJboV0z_left" class="column frame-1-c"><div id="frameJboV0z_left_temp" class="move-span temp"></div><?php block_display('2465');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framefw2Jk0" class=" frame move-span cl frame-1"><div id="framefw2Jk0_left" class="column frame-1-c"><div id="framefw2Jk0_left_temp" class="move-span temp"></div><?php block_display('2463');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framehDds0u" class="cl_frame_bm frame move-span cl frame-1"><div id="framehDds0u_left" class="column frame-1-c"><div id="framehDds0u_left_temp" class="move-span temp"></div><?php block_display('2454');?><?php block_display('2455');?><?php block_display('2456');?><?php block_display('2457');?><?php block_display('2458');?><?php block_display('2459');?><?php block_display('2460');?><?php block_display('2461');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameEbL6Cz" class="frame move-span cl frame-1"><div id="frameEbL6Cz_left" class="column frame-1-c"><div id="frameEbL6Cz_left_temp" class="move-span temp"></div><?php block_display('2464');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
