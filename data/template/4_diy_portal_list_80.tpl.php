<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_80');
block_get('2198,2201,2199,2190,2191,2192,2193,2194,2195,2196,2197,2200');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameRc4uxt" class="cl_frame_bm frame move-span cl frame-1"><div id="frameRc4uxt_left" class="column frame-1-c"><div id="frameRc4uxt_left_temp" class="move-span temp"></div><?php block_display('2198');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2191 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2193 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2195 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2198 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameVXWcO2 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameqxz8PH" class="frame move-span cl frame-1"><div id="frameqxz8PH_left" class="column frame-1-c"><div id="frameqxz8PH_left_temp" class="move-span temp"></div><?php block_display('2201');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameVXWcO2" class=" frame move-span cl frame-1"><div id="frameVXWcO2_left" class="column frame-1-c"><div id="frameVXWcO2_left_temp" class="move-span temp"></div><?php block_display('2199');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameL4972b" class="cl_frame_bm frame move-span cl frame-1"><div id="frameL4972b_left" class="column frame-1-c"><div id="frameL4972b_left_temp" class="move-span temp"></div><?php block_display('2190');?><?php block_display('2191');?><?php block_display('2192');?><?php block_display('2193');?><?php block_display('2194');?><?php block_display('2195');?><?php block_display('2196');?><?php block_display('2197');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framenm7X54" class="frame move-span cl frame-1"><div id="framenm7X54_left" class="column frame-1-c"><div id="framenm7X54_left_temp" class="move-span temp"></div><?php block_display('2200');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
