...
0
|| checktplrefresh('data/diy/./template/comiis_meizhou/portal/view_15.htm', './template/default/portal/portal_comment.htm', 1527844267, 'diy', './data/template/3_diy_portal_view.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view')
|| checktplrefresh('data/diy/./template/comiis_meizhou/portal/view_15.htm', './template/default/common/seccheck.htm', 1527844267, 'diy', './data/template/3_diy_portal_view.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view')
;
