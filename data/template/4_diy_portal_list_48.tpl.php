<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_48');
block_get('2762,2765,2763,2754,2755,2756,2757,2758,2759,2760,2761,2764');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameoe9c5r" class="cl_frame_bm frame move-span cl frame-1"><div id="frameoe9c5r_left" class="column frame-1-c"><div id="frameoe9c5r_left_temp" class="move-span temp"></div><?php block_display('2762');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2755 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2757 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2759 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2762 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameje5B3N {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framex1JOhe" class="frame move-span cl frame-1"><div id="framex1JOhe_left" class="column frame-1-c"><div id="framex1JOhe_left_temp" class="move-span temp"></div><?php block_display('2765');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameje5B3N" class=" frame move-span cl frame-1"><div id="frameje5B3N_left" class="column frame-1-c"><div id="frameje5B3N_left_temp" class="move-span temp"></div><?php block_display('2763');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameZWgdHn" class="cl_frame_bm frame move-span cl frame-1"><div id="frameZWgdHn_left" class="column frame-1-c"><div id="frameZWgdHn_left_temp" class="move-span temp"></div><?php block_display('2754');?><?php block_display('2755');?><?php block_display('2756');?><?php block_display('2757');?><?php block_display('2758');?><?php block_display('2759');?><?php block_display('2760');?><?php block_display('2761');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameaoP1NF" class="frame move-span cl frame-1"><div id="frameaoP1NF_left" class="column frame-1-c"><div id="frameaoP1NF_left_temp" class="move-span temp"></div><?php block_display('2764');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
