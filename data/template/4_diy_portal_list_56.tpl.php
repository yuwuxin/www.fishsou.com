<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_56');
block_get('2858,2861,2859,2850,2851,2852,2853,2854,2855,2856,2857,2860');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framez4hheE" class="cl_frame_bm frame move-span cl frame-1"><div id="framez4hheE_left" class="column frame-1-c"><div id="framez4hheE_left_temp" class="move-span temp"></div><?php block_display('2858');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2851 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2853 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2855 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2858 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameglJJdX {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameXwip6p" class="frame move-span cl frame-1"><div id="frameXwip6p_left" class="column frame-1-c"><div id="frameXwip6p_left_temp" class="move-span temp"></div><?php block_display('2861');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameglJJdX" class=" frame move-span cl frame-1"><div id="frameglJJdX_left" class="column frame-1-c"><div id="frameglJJdX_left_temp" class="move-span temp"></div><?php block_display('2859');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framez7nBQl" class="cl_frame_bm frame move-span cl frame-1"><div id="framez7nBQl_left" class="column frame-1-c"><div id="framez7nBQl_left_temp" class="move-span temp"></div><?php block_display('2850');?><?php block_display('2851');?><?php block_display('2852');?><?php block_display('2853');?><?php block_display('2854');?><?php block_display('2855');?><?php block_display('2856');?><?php block_display('2857');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameAKppkY" class="frame move-span cl frame-1"><div id="frameAKppkY_left" class="column frame-1-c"><div id="frameAKppkY_left_temp" class="move-span temp"></div><?php block_display('2860');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
