<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_23');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_23.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844848, 'diy', './data/template/4_diy_portal_view_23.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_23')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_23.htm', './template/default/common/seccheck.htm', 1527844848, 'diy', './data/template/4_diy_portal_view_23.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_23')
;
block_get('3146,3149,3147,3138,3139,3140,3141,3142,3143,3144,3145,3148');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameVuYF0E" class="frame move-span cl frame-1"><div id="frameVuYF0E_left" class="column frame-1-c"><div id="frameVuYF0E_left_temp" class="move-span temp"></div></div></div><div id="frameRCJslZ" class="cl_frame_bm frame move-span cl frame-1"><div id="frameRCJslZ_left" class="column frame-1-c"><div id="frameRCJslZ_left_temp" class="move-span temp"></div><?php block_display('3146');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3139 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3141 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3143 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3146 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameak8V09 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameR1r7V7" class="frame move-span cl frame-1"><div id="frameR1r7V7_left" class="column frame-1-c"><div id="frameR1r7V7_left_temp" class="move-span temp"></div><?php block_display('3149');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameak8V09" class=" frame move-span cl frame-1"><div id="frameak8V09_left" class="column frame-1-c"><div id="frameak8V09_left_temp" class="move-span temp"></div><?php block_display('3147');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framestWxkl" class="cl_frame_bm frame move-span cl frame-1"><div id="framestWxkl_left" class="column frame-1-c"><div id="framestWxkl_left_temp" class="move-span temp"></div><?php block_display('3138');?><?php block_display('3139');?><?php block_display('3140');?><?php block_display('3141');?><?php block_display('3142');?><?php block_display('3143');?><?php block_display('3144');?><?php block_display('3145');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framevO42Fj" class="frame move-span cl frame-1"><div id="framevO42Fj_left" class="column frame-1-c"><div id="framevO42Fj_left_temp" class="move-span temp"></div><?php block_display('3148');?></div></div></div><!--[/diy]-->
</div>
