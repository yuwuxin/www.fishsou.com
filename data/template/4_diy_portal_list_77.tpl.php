<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_77');
block_get('2642,2645,2643,2634,2635,2636,2637,2638,2639,2640,2641,2644');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameO5ER60" class="cl_frame_bm frame move-span cl frame-1"><div id="frameO5ER60_left" class="column frame-1-c"><div id="frameO5ER60_left_temp" class="move-span temp"></div><?php block_display('2642');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2635 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2637 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2639 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2642 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framew19WCN {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framefW3MTY" class="frame move-span cl frame-1"><div id="framefW3MTY_left" class="column frame-1-c"><div id="framefW3MTY_left_temp" class="move-span temp"></div><?php block_display('2645');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framew19WCN" class=" frame move-span cl frame-1"><div id="framew19WCN_left" class="column frame-1-c"><div id="framew19WCN_left_temp" class="move-span temp"></div><?php block_display('2643');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framejnPzKv" class="cl_frame_bm frame move-span cl frame-1"><div id="framejnPzKv_left" class="column frame-1-c"><div id="framejnPzKv_left_temp" class="move-span temp"></div><?php block_display('2634');?><?php block_display('2635');?><?php block_display('2636');?><?php block_display('2637');?><?php block_display('2638');?><?php block_display('2639');?><?php block_display('2640');?><?php block_display('2641');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framecWCToz" class="frame move-span cl frame-1"><div id="framecWCToz_left" class="column frame-1-c"><div id="framecWCToz_left_temp" class="move-span temp"></div><?php block_display('2644');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
