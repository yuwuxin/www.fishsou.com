<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_78');
block_get('2654,2657,2655,2646,2647,2648,2649,2650,2651,2652,2653,2656');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framevxFoJs" class="cl_frame_bm frame move-span cl frame-1"><div id="framevxFoJs_left" class="column frame-1-c"><div id="framevxFoJs_left_temp" class="move-span temp"></div><?php block_display('2654');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2647 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2649 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2651 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2654 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameGmNFNp {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framevHAzA8" class="frame move-span cl frame-1"><div id="framevHAzA8_left" class="column frame-1-c"><div id="framevHAzA8_left_temp" class="move-span temp"></div><?php block_display('2657');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameGmNFNp" class=" frame move-span cl frame-1"><div id="frameGmNFNp_left" class="column frame-1-c"><div id="frameGmNFNp_left_temp" class="move-span temp"></div><?php block_display('2655');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameUTrawW" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUTrawW_left" class="column frame-1-c"><div id="frameUTrawW_left_temp" class="move-span temp"></div><?php block_display('2646');?><?php block_display('2647');?><?php block_display('2648');?><?php block_display('2649');?><?php block_display('2650');?><?php block_display('2651');?><?php block_display('2652');?><?php block_display('2653');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framenzUSff" class="frame move-span cl frame-1"><div id="framenzUSff_left" class="column frame-1-c"><div id="framenzUSff_left_temp" class="move-span temp"></div><?php block_display('2656');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
