<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_90');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_90.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527846495, 'diy', './data/template/4_diy_portal_view_90.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_90')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_90.htm', './template/default/common/seccheck.htm', 1527846495, 'diy', './data/template/4_diy_portal_view_90.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_90')
;
block_get('3242,3245,3243,3234,3235,3236,3237,3238,3239,3240,3241,3244');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framebc3wSz" class="frame move-span cl frame-1"><div id="framebc3wSz_left" class="column frame-1-c"><div id="framebc3wSz_left_temp" class="move-span temp"></div></div></div><div id="frameKcztiR" class="cl_frame_bm frame move-span cl frame-1"><div id="frameKcztiR_left" class="column frame-1-c"><div id="frameKcztiR_left_temp" class="move-span temp"></div><?php block_display('3242');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3235 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3237 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3239 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3242 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameyPRpny {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameCXJ332" class="frame move-span cl frame-1"><div id="frameCXJ332_left" class="column frame-1-c"><div id="frameCXJ332_left_temp" class="move-span temp"></div><?php block_display('3245');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameyPRpny" class=" frame move-span cl frame-1"><div id="frameyPRpny_left" class="column frame-1-c"><div id="frameyPRpny_left_temp" class="move-span temp"></div><?php block_display('3243');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framejrZ92V" class="cl_frame_bm frame move-span cl frame-1"><div id="framejrZ92V_left" class="column frame-1-c"><div id="framejrZ92V_left_temp" class="move-span temp"></div><?php block_display('3234');?><?php block_display('3235');?><?php block_display('3236');?><?php block_display('3237');?><?php block_display('3238');?><?php block_display('3239');?><?php block_display('3240');?><?php block_display('3241');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameuG6yUp" class="frame move-span cl frame-1"><div id="frameuG6yUp_left" class="column frame-1-c"><div id="frameuG6yUp_left_temp" class="move-span temp"></div><?php block_display('3244');?></div></div></div><!--[/diy]-->
</div>
