<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_50');
block_get('2786,2789,2787,2778,2779,2780,2781,2782,2783,2784,2785,2788');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framevLpNJl" class="cl_frame_bm frame move-span cl frame-1"><div id="framevLpNJl_left" class="column frame-1-c"><div id="framevLpNJl_left_temp" class="move-span temp"></div><?php block_display('2786');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2779 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2781 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2783 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2786 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameNO44Ha {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framewEuJ80" class="frame move-span cl frame-1"><div id="framewEuJ80_left" class="column frame-1-c"><div id="framewEuJ80_left_temp" class="move-span temp"></div><?php block_display('2789');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameNO44Ha" class=" frame move-span cl frame-1"><div id="frameNO44Ha_left" class="column frame-1-c"><div id="frameNO44Ha_left_temp" class="move-span temp"></div><?php block_display('2787');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameOTRPfE" class="cl_frame_bm frame move-span cl frame-1"><div id="frameOTRPfE_left" class="column frame-1-c"><div id="frameOTRPfE_left_temp" class="move-span temp"></div><?php block_display('2778');?><?php block_display('2779');?><?php block_display('2780');?><?php block_display('2781');?><?php block_display('2782');?><?php block_display('2783');?><?php block_display('2784');?><?php block_display('2785');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameLHrVjk" class="frame move-span cl frame-1"><div id="frameLHrVjk_left" class="column frame-1-c"><div id="frameLHrVjk_left_temp" class="move-span temp"></div><?php block_display('2788');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
