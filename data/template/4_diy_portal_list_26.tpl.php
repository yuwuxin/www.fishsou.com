<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_26');
block_get('2366,2369,2367,2358,2359,2360,2361,2362,2363,2364,2365,2368');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameE30Jri" class="cl_frame_bm frame move-span cl frame-1"><div id="frameE30Jri_left" class="column frame-1-c"><div id="frameE30Jri_left_temp" class="move-span temp"></div><?php block_display('2366');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2359 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2361 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2363 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2366 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameV7h797 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameH2AzsR" class="frame move-span cl frame-1"><div id="frameH2AzsR_left" class="column frame-1-c"><div id="frameH2AzsR_left_temp" class="move-span temp"></div><?php block_display('2369');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameV7h797" class=" frame move-span cl frame-1"><div id="frameV7h797_left" class="column frame-1-c"><div id="frameV7h797_left_temp" class="move-span temp"></div><?php block_display('2367');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameV1tnGO" class="cl_frame_bm frame move-span cl frame-1"><div id="frameV1tnGO_left" class="column frame-1-c"><div id="frameV1tnGO_left_temp" class="move-span temp"></div><?php block_display('2358');?><?php block_display('2359');?><?php block_display('2360');?><?php block_display('2361');?><?php block_display('2362');?><?php block_display('2363');?><?php block_display('2364');?><?php block_display('2365');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framefcFpxH" class="frame move-span cl frame-1"><div id="framefcFpxH_left" class="column frame-1-c"><div id="framefcFpxH_left_temp" class="move-span temp"></div><?php block_display('2368');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
