<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_28');
block_get('2390,2393,2391,2382,2383,2384,2385,2386,2387,2388,2389,2392');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameM6P7ZM" class="cl_frame_bm frame move-span cl frame-1"><div id="frameM6P7ZM_left" class="column frame-1-c"><div id="frameM6P7ZM_left_temp" class="move-span temp"></div><?php block_display('2390');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2383 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2385 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2387 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2390 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameCK7zhh {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framesk00X5" class="frame move-span cl frame-1"><div id="framesk00X5_left" class="column frame-1-c"><div id="framesk00X5_left_temp" class="move-span temp"></div><?php block_display('2393');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameCK7zhh" class=" frame move-span cl frame-1"><div id="frameCK7zhh_left" class="column frame-1-c"><div id="frameCK7zhh_left_temp" class="move-span temp"></div><?php block_display('2391');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameuAbaO7" class="cl_frame_bm frame move-span cl frame-1"><div id="frameuAbaO7_left" class="column frame-1-c"><div id="frameuAbaO7_left_temp" class="move-span temp"></div><?php block_display('2382');?><?php block_display('2383');?><?php block_display('2384');?><?php block_display('2385');?><?php block_display('2386');?><?php block_display('2387');?><?php block_display('2388');?><?php block_display('2389');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framelakAt0" class="frame move-span cl frame-1"><div id="framelakAt0_left" class="column frame-1-c"><div id="framelakAt0_left_temp" class="move-span temp"></div><?php block_display('2392');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
