<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_18');
block_get('3110,3113,3111,3102,3103,3104,3105,3106,3107,3108,3109,3112');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameaK3hL8" class="cl_frame_bm frame move-span cl frame-1"><div id="frameaK3hL8_left" class="column frame-1-c"><div id="frameaK3hL8_left_temp" class="move-span temp"></div><?php block_display('3110');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3103 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3105 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3107 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3110 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameaBIqT7 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framePDVDbK" class="frame move-span cl frame-1"><div id="framePDVDbK_left" class="column frame-1-c"><div id="framePDVDbK_left_temp" class="move-span temp"></div><?php block_display('3113');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameaBIqT7" class=" frame move-span cl frame-1"><div id="frameaBIqT7_left" class="column frame-1-c"><div id="frameaBIqT7_left_temp" class="move-span temp"></div><?php block_display('3111');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameu8n9n6" class="cl_frame_bm frame move-span cl frame-1"><div id="frameu8n9n6_left" class="column frame-1-c"><div id="frameu8n9n6_left_temp" class="move-span temp"></div><?php block_display('3102');?><?php block_display('3103');?><?php block_display('3104');?><?php block_display('3105');?><?php block_display('3106');?><?php block_display('3107');?><?php block_display('3108');?><?php block_display('3109');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framev5f5rD" class="frame move-span cl frame-1"><div id="framev5f5rD_left" class="column frame-1-c"><div id="framev5f5rD_left_temp" class="move-span temp"></div><?php block_display('3112');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
