<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_11');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_11.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844217, 'diy', './data/template/4_diy_portal_view_11.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_11')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_11.htm', './template/default/common/seccheck.htm', 1527844217, 'diy', './data/template/4_diy_portal_view_11.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_11')
;
block_get('2054,2057,2055,2046,2047,2048,2049,2050,2051,2052,2053,2056');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameU2X99Z" class="frame move-span cl frame-1"><div id="frameU2X99Z_left" class="column frame-1-c"><div id="frameU2X99Z_left_temp" class="move-span temp"></div></div></div><div id="frameTC6xcO" class="cl_frame_bm frame move-span cl frame-1"><div id="frameTC6xcO_left" class="column frame-1-c"><div id="frameTC6xcO_left_temp" class="move-span temp"></div><?php block_display('2054');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2047 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2049 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2051 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2054 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameI7N2k2 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameBXxMZB" class="frame move-span cl frame-1"><div id="frameBXxMZB_left" class="column frame-1-c"><div id="frameBXxMZB_left_temp" class="move-span temp"></div><?php block_display('2057');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameI7N2k2" class=" frame move-span cl frame-1"><div id="frameI7N2k2_left" class="column frame-1-c"><div id="frameI7N2k2_left_temp" class="move-span temp"></div><?php block_display('2055');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameM1TxC2" class="cl_frame_bm frame move-span cl frame-1"><div id="frameM1TxC2_left" class="column frame-1-c"><div id="frameM1TxC2_left_temp" class="move-span temp"></div><?php block_display('2046');?><?php block_display('2047');?><?php block_display('2048');?><?php block_display('2049');?><?php block_display('2050');?><?php block_display('2051');?><?php block_display('2052');?><?php block_display('2053');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameAzYhaU" class="frame move-span cl frame-1"><div id="frameAzYhaU_left" class="column frame-1-c"><div id="frameAzYhaU_left_temp" class="move-span temp"></div><?php block_display('2056');?></div></div></div><!--[/diy]-->
</div>
