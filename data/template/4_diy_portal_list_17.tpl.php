<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_17');
block_get('1994,1997,1995,1986,1987,1988,1989,1990,1991,1992,1993,1996');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameoUOrRw" class="cl_frame_bm frame move-span cl frame-1"><div id="frameoUOrRw_left" class="column frame-1-c"><div id="frameoUOrRw_left_temp" class="move-span temp"></div><?php block_display('1994');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1987 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1989 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1991 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1994 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameOIZ3I9 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameNbssDh" class="frame move-span cl frame-1"><div id="frameNbssDh_left" class="column frame-1-c"><div id="frameNbssDh_left_temp" class="move-span temp"></div><?php block_display('1997');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameOIZ3I9" class=" frame move-span cl frame-1"><div id="frameOIZ3I9_left" class="column frame-1-c"><div id="frameOIZ3I9_left_temp" class="move-span temp"></div><?php block_display('1995');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framek0wyyT" class="cl_frame_bm frame move-span cl frame-1"><div id="framek0wyyT_left" class="column frame-1-c"><div id="framek0wyyT_left_temp" class="move-span temp"></div><?php block_display('1986');?><?php block_display('1987');?><?php block_display('1988');?><?php block_display('1989');?><?php block_display('1990');?><?php block_display('1991');?><?php block_display('1992');?><?php block_display('1993');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameI2KV1t" class="frame move-span cl frame-1"><div id="frameI2KV1t_left" class="column frame-1-c"><div id="frameI2KV1t_left_temp" class="move-span temp"></div><?php block_display('1996');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
