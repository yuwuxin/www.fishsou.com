<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_62');
block_get('2930,2933,2931,2922,2923,2924,2925,2926,2927,2928,2929,2932');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameQadA4d" class="cl_frame_bm frame move-span cl frame-1"><div id="frameQadA4d_left" class="column frame-1-c"><div id="frameQadA4d_left_temp" class="move-span temp"></div><?php block_display('2930');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2923 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2925 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2927 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2930 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framep8uks1 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameIjhx7u" class="frame move-span cl frame-1"><div id="frameIjhx7u_left" class="column frame-1-c"><div id="frameIjhx7u_left_temp" class="move-span temp"></div><?php block_display('2933');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framep8uks1" class=" frame move-span cl frame-1"><div id="framep8uks1_left" class="column frame-1-c"><div id="framep8uks1_left_temp" class="move-span temp"></div><?php block_display('2931');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameDtIIV3" class="cl_frame_bm frame move-span cl frame-1"><div id="frameDtIIV3_left" class="column frame-1-c"><div id="frameDtIIV3_left_temp" class="move-span temp"></div><?php block_display('2922');?><?php block_display('2923');?><?php block_display('2924');?><?php block_display('2925');?><?php block_display('2926');?><?php block_display('2927');?><?php block_display('2928');?><?php block_display('2929');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameZNsS39" class="frame move-span cl frame-1"><div id="frameZNsS39_left" class="column frame-1-c"><div id="frameZNsS39_left_temp" class="move-span temp"></div><?php block_display('2932');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
