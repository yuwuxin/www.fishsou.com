<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_85');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_85.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527859041, 'diy', './data/template/4_diy_portal_view_85.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_85')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_85.htm', './template/default/common/seccheck.htm', 1527859041, 'diy', './data/template/4_diy_portal_view_85.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_85')
;
block_get('3302,3305,3303,3294,3295,3296,3297,3298,3299,3300,3301,3304');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framezMXRjv" class="frame move-span cl frame-1"><div id="framezMXRjv_left" class="column frame-1-c"><div id="framezMXRjv_left_temp" class="move-span temp"></div></div></div><div id="frameL221zT" class="cl_frame_bm frame move-span cl frame-1"><div id="frameL221zT_left" class="column frame-1-c"><div id="frameL221zT_left_temp" class="move-span temp"></div><?php block_display('3302');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3295 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3297 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3299 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3302 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameFo2bN2 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="framesCRGig" class="frame move-span cl frame-1"><div id="framesCRGig_left" class="column frame-1-c"><div id="framesCRGig_left_temp" class="move-span temp"></div><?php block_display('3305');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameFo2bN2" class=" frame move-span cl frame-1"><div id="frameFo2bN2_left" class="column frame-1-c"><div id="frameFo2bN2_left_temp" class="move-span temp"></div><?php block_display('3303');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framezNQ0b0" class="cl_frame_bm frame move-span cl frame-1"><div id="framezNQ0b0_left" class="column frame-1-c"><div id="framezNQ0b0_left_temp" class="move-span temp"></div><?php block_display('3294');?><?php block_display('3295');?><?php block_display('3296');?><?php block_display('3297');?><?php block_display('3298');?><?php block_display('3299');?><?php block_display('3300');?><?php block_display('3301');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framePWlx9F" class="frame move-span cl frame-1"><div id="framePWlx9F_left" class="column frame-1-c"><div id="framePWlx9F_left_temp" class="move-span temp"></div><?php block_display('3304');?></div></div></div><!--[/diy]-->
</div>
