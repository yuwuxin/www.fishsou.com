<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_101');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_101.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527845614, 'diy', './data/template/4_diy_portal_view_101.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_101')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_101.htm', './template/default/common/seccheck.htm', 1527845614, 'diy', './data/template/4_diy_portal_view_101.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_101')
;
block_get('3218,3221,3219,3210,3211,3212,3213,3214,3215,3216,3217,3220');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameCY9zNy" class="frame move-span cl frame-1"><div id="frameCY9zNy_left" class="column frame-1-c"><div id="frameCY9zNy_left_temp" class="move-span temp"></div></div></div><div id="frameonnnDW" class="cl_frame_bm frame move-span cl frame-1"><div id="frameonnnDW_left" class="column frame-1-c"><div id="frameonnnDW_left_temp" class="move-span temp"></div><?php block_display('3218');?></div></div></div><!--[/diy]-->
<?php if($comiis_wz_fl==1 && $cat['others']) { ?>
<div class="comiis_wz_fl cl"<?php if($comiis_wz_nv!=1) { ?> style="margin-top:10px;"<?php } ?>><?php if(is_array($cat['others'])) foreach($cat['others'] as $value) { ?><a href="<?php echo getportalcategoryurl($value['catid']); ?>"<?php if($value['catid']==$cat['catid']) { ?> class="on"<?php } ?>><?php echo $value['catname'];?></a>
<?php } ?>
</div>
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3211 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3213 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3215 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3218 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameVog0LC {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameh0WgwG" class="frame move-span cl frame-1"><div id="frameh0WgwG_left" class="column frame-1-c"><div id="frameh0WgwG_left_temp" class="move-span temp"></div><?php block_display('3221');?></div></div></div><!--[/diy]-->
<div class="d">
...
<?php if($article['nextarticle']) { ?><em class="y">下一篇：<a href="<?php echo $article['nextarticle']['url'];?>" title="<?php echo $article['nextarticle']['title'];?>"><?php echo $article['nextarticle']['title'];?></a></em><?php } if($article['prearticle']) { ?><em>上一篇：<a href="<?php echo $article['prearticle']['url'];?>" title="<?php echo $article['prearticle']['title'];?>"><?php echo $article['prearticle']['title'];?></a></em><?php } ?>				
</div>
<?php } ?>
</div>
...
<div class="comiis_wz_titname cl"><h2 class="kmblue">相关阅读</h2></div>
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameVog0LC" class=" frame move-span cl frame-1"><div id="frameVog0LC_left" class="column frame-1-c"><div id="frameVog0LC_left_temp" class="move-span temp"></div><?php block_display('3219');?></div></div></div><!--[/diy]-->
</div>
<?php if($comiis_wz_fl==2 && $cat['others']) { ?>
<div class="comiis_wz_titname cl"><h2>相关分类</h2></div>
<div class="comiis_wz_rfl cl">
<ul><?php if(is_array($cat['others'])) foreach($cat['others'] as $value) { ?><li>&bull; <a href="<?php echo getportalcategoryurl($value['catid']); ?>"><?php echo $value['catname'];?></a></li>
<?php } ?>
</ul>
</div>
<?php } if($comiis_wz_vfl==1 && $cat['subs']) { ?>
<div class="comiis_wz_titname cl"><h2>下级分类</h2></div>
<div class="comiis_wz_rfl cl">
<ul><?php if(is_array($cat['subs'])) foreach($cat['subs'] as $value) { ?><li>&bull; <a href="<?php echo getportalcategoryurl($value['catid']); ?>"><?php echo $value['catname'];?></a></li>
<?php } ?>
</ul>
</div>
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framephZe9D" class="cl_frame_bm frame move-span cl frame-1"><div id="framephZe9D_left" class="column frame-1-c"><div id="framephZe9D_left_temp" class="move-span temp"></div><?php block_display('3210');?><?php block_display('3211');?><?php block_display('3212');?><?php block_display('3213');?><?php block_display('3214');?><?php block_display('3215');?><?php block_display('3216');?><?php block_display('3217');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameOuPTDP" class="frame move-span cl frame-1"><div id="frameOuPTDP_left" class="column frame-1-c"><div id="frameOuPTDP_left_temp" class="move-span temp"></div><?php block_display('3220');?></div></div></div><!--[/diy]-->
</div>
