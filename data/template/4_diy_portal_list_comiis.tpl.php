<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_comiis');?>
﻿<?php include template('common/header'); ?><!--[name]AB模板网建站-梅州社区列表页[/name]--><?php $list = array();?><?php $wheresql = category_get_wheresql($cat);?><?php $list = category_get_list($cat, $wheresql, $page);?><?php if($comiis_wz_nv==1) { ?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"></div><!--[/diy]-->
