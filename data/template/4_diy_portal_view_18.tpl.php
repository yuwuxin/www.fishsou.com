<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_18');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_18.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844910, 'diy', './data/template/4_diy_portal_view_18.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_18')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_18.htm', './template/default/common/seccheck.htm', 1527844910, 'diy', './data/template/4_diy_portal_view_18.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_18')
;
block_get('3122,3125,3123,3114,3115,3116,3117,3118,3119,3120,3121,3124');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameJlvBrw" class="frame move-span cl frame-1"><div id="frameJlvBrw_left" class="column frame-1-c"><div id="frameJlvBrw_left_temp" class="move-span temp"></div></div></div><div id="frameEbGT3y" class="cl_frame_bm frame move-span cl frame-1"><div id="frameEbGT3y_left" class="column frame-1-c"><div id="frameEbGT3y_left_temp" class="move-span temp"></div><?php block_display('3122');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3115 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3117 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3119 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3122 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framej4BMQZ {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameFP288g" class="frame move-span cl frame-1"><div id="frameFP288g_left" class="column frame-1-c"><div id="frameFP288g_left_temp" class="move-span temp"></div><?php block_display('3125');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framej4BMQZ" class=" frame move-span cl frame-1"><div id="framej4BMQZ_left" class="column frame-1-c"><div id="framej4BMQZ_left_temp" class="move-span temp"></div><?php block_display('3123');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framexn9m9q" class="cl_frame_bm frame move-span cl frame-1"><div id="framexn9m9q_left" class="column frame-1-c"><div id="framexn9m9q_left_temp" class="move-span temp"></div><?php block_display('3114');?><?php block_display('3115');?><?php block_display('3116');?><?php block_display('3117');?><?php block_display('3118');?><?php block_display('3119');?><?php block_display('3120');?><?php block_display('3121');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameWG1bDL" class="frame move-span cl frame-1"><div id="frameWG1bDL_left" class="column frame-1-c"><div id="frameWG1bDL_left_temp" class="move-span temp"></div><?php block_display('3124');?></div></div></div><!--[/diy]-->
</div>
