<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_24');
block_get('2162,2165,2163,2154,2155,2156,2157,2158,2159,2160,2161,2164');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framejyGYk5" class="cl_frame_bm frame move-span cl frame-1"><div id="framejyGYk5_left" class="column frame-1-c"><div id="framejyGYk5_left_temp" class="move-span temp"></div><?php block_display('2162');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2155 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2157 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2159 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2162 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameZp0Z0M {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameYg2126" class="frame move-span cl frame-1"><div id="frameYg2126_left" class="column frame-1-c"><div id="frameYg2126_left_temp" class="move-span temp"></div><?php block_display('2165');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameZp0Z0M" class=" frame move-span cl frame-1"><div id="frameZp0Z0M_left" class="column frame-1-c"><div id="frameZp0Z0M_left_temp" class="move-span temp"></div><?php block_display('2163');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameBqqu5w" class="cl_frame_bm frame move-span cl frame-1"><div id="frameBqqu5w_left" class="column frame-1-c"><div id="frameBqqu5w_left_temp" class="move-span temp"></div><?php block_display('2154');?><?php block_display('2155');?><?php block_display('2156');?><?php block_display('2157');?><?php block_display('2158');?><?php block_display('2159');?><?php block_display('2160');?><?php block_display('2161');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framerecX0e" class="frame move-span cl frame-1"><div id="framerecX0e_left" class="column frame-1-c"><div id="framerecX0e_left_temp" class="move-span temp"></div><?php block_display('2164');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
