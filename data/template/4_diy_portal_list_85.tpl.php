<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_85');
block_get('2270,2273,2271,2262,2263,2264,2265,2266,2267,2268,2269,2272');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameUx13wb" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUx13wb_left" class="column frame-1-c"><div id="frameUx13wb_left_temp" class="move-span temp"></div><?php block_display('2270');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2263 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2265 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2267 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2270 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framePyh0nR {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameaPqBzv" class="frame move-span cl frame-1"><div id="frameaPqBzv_left" class="column frame-1-c"><div id="frameaPqBzv_left_temp" class="move-span temp"></div><?php block_display('2273');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framePyh0nR" class=" frame move-span cl frame-1"><div id="framePyh0nR_left" class="column frame-1-c"><div id="framePyh0nR_left_temp" class="move-span temp"></div><?php block_display('2271');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameDy5z7N" class="cl_frame_bm frame move-span cl frame-1"><div id="frameDy5z7N_left" class="column frame-1-c"><div id="frameDy5z7N_left_temp" class="move-span temp"></div><?php block_display('2262');?><?php block_display('2263');?><?php block_display('2264');?><?php block_display('2265');?><?php block_display('2266');?><?php block_display('2267');?><?php block_display('2268');?><?php block_display('2269');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameJf4Wym" class="frame move-span cl frame-1"><div id="frameJf4Wym_left" class="column frame-1-c"><div id="frameJf4Wym_left_temp" class="move-span temp"></div><?php block_display('2272');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
