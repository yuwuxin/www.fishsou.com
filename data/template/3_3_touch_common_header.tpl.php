...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1527844267, '3', './data/template/3_3_touch_common_header.tpl.php', './template/zvis_005', 'touch/common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1527844267, '3', './data/template/3_3_touch_common_header.tpl.php', './template/zvis_005', 'touch/common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1527844267, '3', './data/template/3_3_touch_common_header.tpl.php', './template/zvis_005', 'touch/common/header')
;?>
