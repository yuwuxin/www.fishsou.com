...
0
|| checktplrefresh('./template/default/portal/view.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527869336, 'diy', './data/template/4_diy_portal_view.tpl.php', './template/comiis_meizhou', 'portal/view')
|| checktplrefresh('./template/default/portal/view.htm', './template/default/common/seccheck.htm', 1527869336, 'diy', './data/template/4_diy_portal_view.tpl.php', './template/comiis_meizhou', 'portal/view')
