<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_41');
block_get('2546,2549,2547,2538,2539,2540,2541,2542,2543,2544,2545,2548');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameSqJss2" class="cl_frame_bm frame move-span cl frame-1"><div id="frameSqJss2_left" class="column frame-1-c"><div id="frameSqJss2_left_temp" class="move-span temp"></div><?php block_display('2546');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2539 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2541 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2543 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2546 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameE1ZvTo {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameOz2iSz" class="frame move-span cl frame-1"><div id="frameOz2iSz_left" class="column frame-1-c"><div id="frameOz2iSz_left_temp" class="move-span temp"></div><?php block_display('2549');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameE1ZvTo" class=" frame move-span cl frame-1"><div id="frameE1ZvTo_left" class="column frame-1-c"><div id="frameE1ZvTo_left_temp" class="move-span temp"></div><?php block_display('2547');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameIdTTKE" class="cl_frame_bm frame move-span cl frame-1"><div id="frameIdTTKE_left" class="column frame-1-c"><div id="frameIdTTKE_left_temp" class="move-span temp"></div><?php block_display('2538');?><?php block_display('2539');?><?php block_display('2540');?><?php block_display('2541');?><?php block_display('2542');?><?php block_display('2543');?><?php block_display('2544');?><?php block_display('2545');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameM8HjxI" class="frame move-span cl frame-1"><div id="frameM8HjxI_left" class="column frame-1-c"><div id="frameM8HjxI_left_temp" class="move-span temp"></div><?php block_display('2548');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
