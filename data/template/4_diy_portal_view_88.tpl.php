<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_88');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_88.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527845282, 'diy', './data/template/4_diy_portal_view_88.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_88')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_88.htm', './template/default/common/seccheck.htm', 1527845282, 'diy', './data/template/4_diy_portal_view_88.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_88')
;
block_get('3362,3365,3363,3354,3355,3356,3357,3358,3359,3360,3361,3364');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameqV81Vu" class="frame move-span cl frame-1"><div id="frameqV81Vu_left" class="column frame-1-c"><div id="frameqV81Vu_left_temp" class="move-span temp"></div></div></div><div id="frameSGCt4P" class="cl_frame_bm frame move-span cl frame-1"><div id="frameSGCt4P_left" class="column frame-1-c"><div id="frameSGCt4P_left_temp" class="move-span temp"></div><?php block_display('3362');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3355 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3357 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3359 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3362 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framek4mPzG {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameYpdwTy" class="frame move-span cl frame-1"><div id="frameYpdwTy_left" class="column frame-1-c"><div id="frameYpdwTy_left_temp" class="move-span temp"></div><?php block_display('3365');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framek4mPzG" class=" frame move-span cl frame-1"><div id="framek4mPzG_left" class="column frame-1-c"><div id="framek4mPzG_left_temp" class="move-span temp"></div><?php block_display('3363');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framenmM8ZS" class="cl_frame_bm frame move-span cl frame-1"><div id="framenmM8ZS_left" class="column frame-1-c"><div id="framenmM8ZS_left_temp" class="move-span temp"></div><?php block_display('3354');?><?php block_display('3355');?><?php block_display('3356');?><?php block_display('3357');?><?php block_display('3358');?><?php block_display('3359');?><?php block_display('3360');?><?php block_display('3361');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameeHx1p1" class="frame move-span cl frame-1"><div id="frameeHx1p1_left" class="column frame-1-c"><div id="frameeHx1p1_left_temp" class="move-span temp"></div><?php block_display('3364');?></div></div></div><!--[/diy]-->
</div>
