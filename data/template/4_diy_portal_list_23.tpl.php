<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_23');
block_get('2150,2153,2151,2142,2143,2144,2145,2146,2147,2148,2149,2152');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameh626ux" class="cl_frame_bm frame move-span cl frame-1"><div id="frameh626ux_left" class="column frame-1-c"><div id="frameh626ux_left_temp" class="move-span temp"></div><?php block_display('2150');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2143 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2145 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2147 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2150 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameCFn55o {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framexXdXOh" class="frame move-span cl frame-1"><div id="framexXdXOh_left" class="column frame-1-c"><div id="framexXdXOh_left_temp" class="move-span temp"></div><?php block_display('2153');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameCFn55o" class=" frame move-span cl frame-1"><div id="frameCFn55o_left" class="column frame-1-c"><div id="frameCFn55o_left_temp" class="move-span temp"></div><?php block_display('2151');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameB3vFsy" class="cl_frame_bm frame move-span cl frame-1"><div id="frameB3vFsy_left" class="column frame-1-c"><div id="frameB3vFsy_left_temp" class="move-span temp"></div><?php block_display('2142');?><?php block_display('2143');?><?php block_display('2144');?><?php block_display('2145');?><?php block_display('2146');?><?php block_display('2147');?><?php block_display('2148');?><?php block_display('2149');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameUZO3fb" class="frame move-span cl frame-1"><div id="frameUZO3fb_left" class="column frame-1-c"><div id="frameUZO3fb_left_temp" class="move-span temp"></div><?php block_display('2152');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
