<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_99');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_99.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527853332, 'diy', './data/template/4_diy_portal_view_99.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_99')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_99.htm', './template/default/common/seccheck.htm', 1527853332, 'diy', './data/template/4_diy_portal_view_99.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_99')
;
block_get('3374,3377,3375,3366,3367,3368,3369,3370,3371,3372,3373,3376');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framezYob22" class="frame move-span cl frame-1"><div id="framezYob22_left" class="column frame-1-c"><div id="framezYob22_left_temp" class="move-span temp"></div></div></div><div id="frameDM961t" class="cl_frame_bm frame move-span cl frame-1"><div id="frameDM961t_left" class="column frame-1-c"><div id="frameDM961t_left_temp" class="move-span temp"></div><?php block_display('3374');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3367 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3369 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3371 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3374 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameB95wwV {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameDx4H1q" class="frame move-span cl frame-1"><div id="frameDx4H1q_left" class="column frame-1-c"><div id="frameDx4H1q_left_temp" class="move-span temp"></div><?php block_display('3377');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameB95wwV" class=" frame move-span cl frame-1"><div id="frameB95wwV_left" class="column frame-1-c"><div id="frameB95wwV_left_temp" class="move-span temp"></div><?php block_display('3375');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameB7vgqv" class="cl_frame_bm frame move-span cl frame-1"><div id="frameB7vgqv_left" class="column frame-1-c"><div id="frameB7vgqv_left_temp" class="move-span temp"></div><?php block_display('3366');?><?php block_display('3367');?><?php block_display('3368');?><?php block_display('3369');?><?php block_display('3370');?><?php block_display('3371');?><?php block_display('3372');?><?php block_display('3373');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameH6orKt" class="frame move-span cl frame-1"><div id="frameH6orKt_left" class="column frame-1-c"><div id="frameH6orKt_left_temp" class="move-span temp"></div><?php block_display('3376');?></div></div></div><!--[/diy]-->
</div>
