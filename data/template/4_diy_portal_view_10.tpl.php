...
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_10.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844092, 'diy', './data/template/4_diy_portal_view_10.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_10')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_10.htm', './template/default/common/seccheck.htm', 1527844092, 'diy', './data/template/4_diy_portal_view_10.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_10')
;
block_get('2042,2045,2043,2034,2035,2036,2037,2038,2039,2040,2041,2044');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framei36xCp" class="frame move-span cl frame-1"><div id="framei36xCp_left" class="column frame-1-c"><div id="framei36xCp_left_temp" class="move-span temp"></div></div></div><div id="framelZKaza" class="cl_frame_bm frame move-span cl frame-1"><div id="framelZKaza_left" class="column frame-1-c"><div id="framelZKaza_left_temp" class="move-span temp"></div><?php block_display('2042');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2035 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2037 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2039 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2042 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framevohZxZ {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="framerv5U9O" class="frame move-span cl frame-1"><div id="framerv5U9O_left" class="column frame-1-c"><div id="framerv5U9O_left_temp" class="move-span temp"></div><?php block_display('2045');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framevohZxZ" class=" frame move-span cl frame-1"><div id="framevohZxZ_left" class="column frame-1-c"><div id="framevohZxZ_left_temp" class="move-span temp"></div><?php block_display('2043');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framej2NNkG" class="cl_frame_bm frame move-span cl frame-1"><div id="framej2NNkG_left" class="column frame-1-c"><div id="framej2NNkG_left_temp" class="move-span temp"></div><?php block_display('2034');?><?php block_display('2035');?><?php block_display('2036');?><?php block_display('2037');?><?php block_display('2038');?><?php block_display('2039');?><?php block_display('2040');?><?php block_display('2041');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameX2D8E7" class="frame move-span cl frame-1"><div id="frameX2D8E7_left" class="column frame-1-c"><div id="frameX2D8E7_left_temp" class="move-span temp"></div><?php block_display('2044');?></div></div></div><!--[/diy]-->
</div>
