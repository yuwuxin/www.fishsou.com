<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_37');
block_get('2498,2501,2499,2490,2491,2492,2493,2494,2495,2496,2497,2500');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameNg10X8" class="cl_frame_bm frame move-span cl frame-1"><div id="frameNg10X8_left" class="column frame-1-c"><div id="frameNg10X8_left_temp" class="move-span temp"></div><?php block_display('2498');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2491 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2493 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2495 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2498 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framePp8Yst {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameK00ISt" class="frame move-span cl frame-1"><div id="frameK00ISt_left" class="column frame-1-c"><div id="frameK00ISt_left_temp" class="move-span temp"></div><?php block_display('2501');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framePp8Yst" class=" frame move-span cl frame-1"><div id="framePp8Yst_left" class="column frame-1-c"><div id="framePp8Yst_left_temp" class="move-span temp"></div><?php block_display('2499');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameGF5oBR" class="cl_frame_bm frame move-span cl frame-1"><div id="frameGF5oBR_left" class="column frame-1-c"><div id="frameGF5oBR_left_temp" class="move-span temp"></div><?php block_display('2490');?><?php block_display('2491');?><?php block_display('2492');?><?php block_display('2493');?><?php block_display('2494');?><?php block_display('2495');?><?php block_display('2496');?><?php block_display('2497');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameD8PTrr" class="frame move-span cl frame-1"><div id="frameD8PTrr_left" class="column frame-1-c"><div id="frameD8PTrr_left_temp" class="move-span temp"></div><?php block_display('2500');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
