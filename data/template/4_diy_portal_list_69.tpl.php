<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_69');
block_get('1574,1566,1567,1568,1569,1570,1571,1572,1573');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framef555rB" class="cl_frame_bm frame move-span cl frame-1"><div id="framef555rB_left" class="column frame-1-c"><div id="framef555rB_left_temp" class="move-span temp"></div><?php block_display('1574');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1567 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1569 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1571 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1574 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
<div class="wp">
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameXass4u" class="cl_frame_bm frame move-span cl frame-1"><div id="frameXass4u_left" class="column frame-1-c"><div id="frameXass4u_left_temp" class="move-span temp"></div><?php block_display('1566');?><?php block_display('1567');?><?php block_display('1568');?><?php block_display('1569');?><?php block_display('1570');?><?php block_display('1571');?><?php block_display('1572');?><?php block_display('1573');?></div></div></div><!--[/diy]-->
<div class="drag">
