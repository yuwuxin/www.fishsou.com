<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_12');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_12.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844000, 'diy', './data/template/4_diy_portal_view_12.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_12')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_12.htm', './template/default/common/seccheck.htm', 1527844000, 'diy', './data/template/4_diy_portal_view_12.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_12')
;
block_get('2102,2105,2103,2094,2095,2096,2097,2098,2099,2100,2101,2104');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framefb2Zkg" class="frame move-span cl frame-1"><div id="framefb2Zkg_left" class="column frame-1-c"><div id="framefb2Zkg_left_temp" class="move-span temp"></div></div></div><div id="frameZq2vb4" class="cl_frame_bm frame move-span cl frame-1"><div id="frameZq2vb4_left" class="column frame-1-c"><div id="frameZq2vb4_left_temp" class="move-span temp"></div><?php block_display('2102');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2095 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2097 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2099 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2102 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameVds262 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameYEToZd" class="frame move-span cl frame-1"><div id="frameYEToZd_left" class="column frame-1-c"><div id="frameYEToZd_left_temp" class="move-span temp"></div><?php block_display('2105');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameVds262" class=" frame move-span cl frame-1"><div id="frameVds262_left" class="column frame-1-c"><div id="frameVds262_left_temp" class="move-span temp"></div><?php block_display('2103');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameX0641s" class="cl_frame_bm frame move-span cl frame-1"><div id="frameX0641s_left" class="column frame-1-c"><div id="frameX0641s_left_temp" class="move-span temp"></div><?php block_display('2094');?><?php block_display('2095');?><?php block_display('2096');?><?php block_display('2097');?><?php block_display('2098');?><?php block_display('2099');?><?php block_display('2100');?><?php block_display('2101');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameiGUh91" class="frame move-span cl frame-1"><div id="frameiGUh91_left" class="column frame-1-c"><div id="frameiGUh91_left_temp" class="move-span temp"></div><?php block_display('2104');?></div></div></div><!--[/diy]-->
</div>
