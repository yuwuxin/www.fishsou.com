<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_25');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_25.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527889715, 'diy', './data/template/4_diy_portal_view_25.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_25')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_25.htm', './template/default/common/seccheck.htm', 1527889715, 'diy', './data/template/4_diy_portal_view_25.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_25')
;
block_get('3194,3197,3195,3186,3187,3188,3189,3190,3191,3192,3193,3196');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameCL7s98" class="frame move-span cl frame-1"><div id="frameCL7s98_left" class="column frame-1-c"><div id="frameCL7s98_left_temp" class="move-span temp"></div></div></div><div id="framen25XHZ" class="cl_frame_bm frame move-span cl frame-1"><div id="framen25XHZ_left" class="column frame-1-c"><div id="framen25XHZ_left_temp" class="move-span temp"></div><?php block_display('3194');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3187 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3189 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3191 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3194 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framepc98Lu {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameIibiJ5" class="frame move-span cl frame-1"><div id="frameIibiJ5_left" class="column frame-1-c"><div id="frameIibiJ5_left_temp" class="move-span temp"></div><?php block_display('3197');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framepc98Lu" class=" frame move-span cl frame-1"><div id="framepc98Lu_left" class="column frame-1-c"><div id="framepc98Lu_left_temp" class="move-span temp"></div><?php block_display('3195');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameon6YJv" class="cl_frame_bm frame move-span cl frame-1"><div id="frameon6YJv_left" class="column frame-1-c"><div id="frameon6YJv_left_temp" class="move-span temp"></div><?php block_display('3186');?><?php block_display('3187');?><?php block_display('3188');?><?php block_display('3189');?><?php block_display('3190');?><?php block_display('3191');?><?php block_display('3192');?><?php block_display('3193');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameb2Ro2u" class="frame move-span cl frame-1"><div id="frameb2Ro2u_left" class="column frame-1-c"><div id="frameb2Ro2u_left_temp" class="move-span temp"></div><?php block_display('3196');?></div></div></div><!--[/diy]-->
</div>
