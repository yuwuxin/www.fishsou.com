<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_13');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_13.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844003, 'diy', './data/template/4_diy_portal_view_13.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_13')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_13.htm', './template/default/common/seccheck.htm', 1527844003, 'diy', './data/template/4_diy_portal_view_13.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_13')
;
block_get('2078,2081,2079,2070,2071,2072,2073,2074,2075,2076,2077,2080');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frametv55fj" class="frame move-span cl frame-1"><div id="frametv55fj_left" class="column frame-1-c"><div id="frametv55fj_left_temp" class="move-span temp"></div></div></div><div id="frameOHbG23" class="cl_frame_bm frame move-span cl frame-1"><div id="frameOHbG23_left" class="column frame-1-c"><div id="frameOHbG23_left_temp" class="move-span temp"></div><?php block_display('2078');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2071 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2073 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2075 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2078 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameVal8qN {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameatNnO2" class="frame move-span cl frame-1"><div id="frameatNnO2_left" class="column frame-1-c"><div id="frameatNnO2_left_temp" class="move-span temp"></div><?php block_display('2081');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameVal8qN" class=" frame move-span cl frame-1"><div id="frameVal8qN_left" class="column frame-1-c"><div id="frameVal8qN_left_temp" class="move-span temp"></div><?php block_display('2079');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameb2NGPx" class="cl_frame_bm frame move-span cl frame-1"><div id="frameb2NGPx_left" class="column frame-1-c"><div id="frameb2NGPx_left_temp" class="move-span temp"></div><?php block_display('2070');?><?php block_display('2071');?><?php block_display('2072');?><?php block_display('2073');?><?php block_display('2074');?><?php block_display('2075');?><?php block_display('2076');?><?php block_display('2077');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameA2M43K" class="frame move-span cl frame-1"><div id="frameA2M43K_left" class="column frame-1-c"><div id="frameA2M43K_left_temp" class="move-span temp"></div><?php block_display('2080');?></div></div></div><!--[/diy]-->
</div>
