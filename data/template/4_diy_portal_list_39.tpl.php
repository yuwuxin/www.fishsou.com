<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_39');
block_get('2522,2525,2523,2514,2515,2516,2517,2518,2519,2520,2521,2524');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameha60qW" class="cl_frame_bm frame move-span cl frame-1"><div id="frameha60qW_left" class="column frame-1-c"><div id="frameha60qW_left_temp" class="move-span temp"></div><?php block_display('2522');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2515 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2517 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2519 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2522 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameBL3Z3N {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framenj3bb9" class="frame move-span cl frame-1"><div id="framenj3bb9_left" class="column frame-1-c"><div id="framenj3bb9_left_temp" class="move-span temp"></div><?php block_display('2525');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameBL3Z3N" class=" frame move-span cl frame-1"><div id="frameBL3Z3N_left" class="column frame-1-c"><div id="frameBL3Z3N_left_temp" class="move-span temp"></div><?php block_display('2523');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameFMzpon" class="cl_frame_bm frame move-span cl frame-1"><div id="frameFMzpon_left" class="column frame-1-c"><div id="frameFMzpon_left_temp" class="move-span temp"></div><?php block_display('2514');?><?php block_display('2515');?><?php block_display('2516');?><?php block_display('2517');?><?php block_display('2518');?><?php block_display('2519');?><?php block_display('2520');?><?php block_display('2521');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameWND3ts" class="frame move-span cl frame-1"><div id="frameWND3ts_left" class="column frame-1-c"><div id="frameWND3ts_left_temp" class="move-span temp"></div><?php block_display('2524');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
