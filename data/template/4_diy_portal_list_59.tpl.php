<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_59');
block_get('2894,2897,2895,2886,2887,2888,2889,2890,2891,2892,2893,2896');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameMW32t2" class="cl_frame_bm frame move-span cl frame-1"><div id="frameMW32t2_left" class="column frame-1-c"><div id="frameMW32t2_left_temp" class="move-span temp"></div><?php block_display('2894');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2887 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2889 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2891 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2894 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framesvrACY {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frames1wSOW" class="frame move-span cl frame-1"><div id="frames1wSOW_left" class="column frame-1-c"><div id="frames1wSOW_left_temp" class="move-span temp"></div><?php block_display('2897');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framesvrACY" class=" frame move-span cl frame-1"><div id="framesvrACY_left" class="column frame-1-c"><div id="framesvrACY_left_temp" class="move-span temp"></div><?php block_display('2895');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameKFDBUm" class="cl_frame_bm frame move-span cl frame-1"><div id="frameKFDBUm_left" class="column frame-1-c"><div id="frameKFDBUm_left_temp" class="move-span temp"></div><?php block_display('2886');?><?php block_display('2887');?><?php block_display('2888');?><?php block_display('2889');?><?php block_display('2890');?><?php block_display('2891');?><?php block_display('2892');?><?php block_display('2893');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameeTMKxV" class="frame move-span cl frame-1"><div id="frameeTMKxV_left" class="column frame-1-c"><div id="frameeTMKxV_left_temp" class="move-span temp"></div><?php block_display('2896');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
