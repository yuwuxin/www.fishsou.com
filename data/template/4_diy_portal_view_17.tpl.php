<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_17');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_17.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844054, 'diy', './data/template/4_diy_portal_view_17.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_17')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_17.htm', './template/default/common/seccheck.htm', 1527844054, 'diy', './data/template/4_diy_portal_view_17.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_17')
;
block_get('3086,3089,3087,3078,3079,3080,3081,3082,3083,3084,3085,3088');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framePH6I9C" class="frame move-span cl frame-1"><div id="framePH6I9C_left" class="column frame-1-c"><div id="framePH6I9C_left_temp" class="move-span temp"></div></div></div><div id="frameJ19Oz1" class="cl_frame_bm frame move-span cl frame-1"><div id="frameJ19Oz1_left" class="column frame-1-c"><div id="frameJ19Oz1_left_temp" class="move-span temp"></div><?php block_display('3086');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3079 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3081 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3083 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3086 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framev4L2Eq {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameV6cD62" class="frame move-span cl frame-1"><div id="frameV6cD62_left" class="column frame-1-c"><div id="frameV6cD62_left_temp" class="move-span temp"></div><?php block_display('3089');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framev4L2Eq" class=" frame move-span cl frame-1"><div id="framev4L2Eq_left" class="column frame-1-c"><div id="framev4L2Eq_left_temp" class="move-span temp"></div><?php block_display('3087');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameRhSkoJ" class="cl_frame_bm frame move-span cl frame-1"><div id="frameRhSkoJ_left" class="column frame-1-c"><div id="frameRhSkoJ_left_temp" class="move-span temp"></div><?php block_display('3078');?><?php block_display('3079');?><?php block_display('3080');?><?php block_display('3081');?><?php block_display('3082');?><?php block_display('3083');?><?php block_display('3084');?><?php block_display('3085');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framew0c8UQ" class="frame move-span cl frame-1"><div id="framew0c8UQ_left" class="column frame-1-c"><div id="framew0c8UQ_left_temp" class="move-span temp"></div><?php block_display('3088');?></div></div></div><!--[/diy]-->
</div>
