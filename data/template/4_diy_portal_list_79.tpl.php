<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_79');
block_get('2666,2669,2667,2658,2659,2660,2661,2662,2663,2664,2665,2668');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framebpELgf" class="cl_frame_bm frame move-span cl frame-1"><div id="framebpELgf_left" class="column frame-1-c"><div id="framebpELgf_left_temp" class="move-span temp"></div><?php block_display('2666');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2659 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2661 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2663 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2666 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameU2k4DI {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framer2laLl" class="frame move-span cl frame-1"><div id="framer2laLl_left" class="column frame-1-c"><div id="framer2laLl_left_temp" class="move-span temp"></div><?php block_display('2669');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameU2k4DI" class=" frame move-span cl frame-1"><div id="frameU2k4DI_left" class="column frame-1-c"><div id="frameU2k4DI_left_temp" class="move-span temp"></div><?php block_display('2667');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framey75SoO" class="cl_frame_bm frame move-span cl frame-1"><div id="framey75SoO_left" class="column frame-1-c"><div id="framey75SoO_left_temp" class="move-span temp"></div><?php block_display('2658');?><?php block_display('2659');?><?php block_display('2660');?><?php block_display('2661');?><?php block_display('2662');?><?php block_display('2663');?><?php block_display('2664');?><?php block_display('2665');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameHM70Jc" class="frame move-span cl frame-1"><div id="frameHM70Jc_left" class="column frame-1-c"><div id="frameHM70Jc_left_temp" class="move-span temp"></div><?php block_display('2668');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
