<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_19');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_19.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844624, 'diy', './data/template/4_diy_portal_view_19.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_19')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_19.htm', './template/default/common/seccheck.htm', 1527844624, 'diy', './data/template/4_diy_portal_view_19.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_19')
;
block_get('2030,2033,2031,2022,2023,2024,2025,2026,2027,2028,2029,2032');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameWnnnNM" class="frame move-span cl frame-1"><div id="frameWnnnNM_left" class="column frame-1-c"><div id="frameWnnnNM_left_temp" class="move-span temp"></div></div></div><div id="framewlcgXH" class="cl_frame_bm frame move-span cl frame-1"><div id="framewlcgXH_left" class="column frame-1-c"><div id="framewlcgXH_left_temp" class="move-span temp"></div><?php block_display('2030');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2023 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2025 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2027 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2030 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameB9Hca1 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameYluVnu" class="frame move-span cl frame-1"><div id="frameYluVnu_left" class="column frame-1-c"><div id="frameYluVnu_left_temp" class="move-span temp"></div><?php block_display('2033');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameB9Hca1" class=" frame move-span cl frame-1"><div id="frameB9Hca1_left" class="column frame-1-c"><div id="frameB9Hca1_left_temp" class="move-span temp"></div><?php block_display('2031');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameRA6dF6" class="cl_frame_bm frame move-span cl frame-1"><div id="frameRA6dF6_left" class="column frame-1-c"><div id="frameRA6dF6_left_temp" class="move-span temp"></div><?php block_display('2022');?><?php block_display('2023');?><?php block_display('2024');?><?php block_display('2025');?><?php block_display('2026');?><?php block_display('2027');?><?php block_display('2028');?><?php block_display('2029');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameIw4A2W" class="frame move-span cl frame-1"><div id="frameIw4A2W_left" class="column frame-1-c"><div id="frameIw4A2W_left_temp" class="move-span temp"></div><?php block_display('2032');?></div></div></div><!--[/diy]-->
</div>
