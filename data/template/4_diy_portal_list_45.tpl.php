<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_45');
block_get('2726,2729,2727,2718,2719,2720,2721,2722,2723,2724,2725,2728');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framepzv55J" class="cl_frame_bm frame move-span cl frame-1"><div id="framepzv55J_left" class="column frame-1-c"><div id="framepzv55J_left_temp" class="move-span temp"></div><?php block_display('2726');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2719 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2721 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2723 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2726 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framehxEdeF {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framerDefOV" class="frame move-span cl frame-1"><div id="framerDefOV_left" class="column frame-1-c"><div id="framerDefOV_left_temp" class="move-span temp"></div><?php block_display('2729');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framehxEdeF" class=" frame move-span cl frame-1"><div id="framehxEdeF_left" class="column frame-1-c"><div id="framehxEdeF_left_temp" class="move-span temp"></div><?php block_display('2727');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framevgZh8w" class="cl_frame_bm frame move-span cl frame-1"><div id="framevgZh8w_left" class="column frame-1-c"><div id="framevgZh8w_left_temp" class="move-span temp"></div><?php block_display('2718');?><?php block_display('2719');?><?php block_display('2720');?><?php block_display('2721');?><?php block_display('2722');?><?php block_display('2723');?><?php block_display('2724');?><?php block_display('2725');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameHYZXIo" class="frame move-span cl frame-1"><div id="frameHYZXIo_left" class="column frame-1-c"><div id="frameHYZXIo_left_temp" class="move-span temp"></div><?php block_display('2728');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
