<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_82');
block_get('2234,2237,2235,2226,2227,2228,2229,2230,2231,2232,2233,2236');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framezNChBS" class="cl_frame_bm frame move-span cl frame-1"><div id="framezNChBS_left" class="column frame-1-c"><div id="framezNChBS_left_temp" class="move-span temp"></div><?php block_display('2234');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2227 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2229 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2231 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2234 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameGLNzLN {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameg1A3MJ" class="frame move-span cl frame-1"><div id="frameg1A3MJ_left" class="column frame-1-c"><div id="frameg1A3MJ_left_temp" class="move-span temp"></div><?php block_display('2237');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameGLNzLN" class=" frame move-span cl frame-1"><div id="frameGLNzLN_left" class="column frame-1-c"><div id="frameGLNzLN_left_temp" class="move-span temp"></div><?php block_display('2235');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameAY99JC" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAY99JC_left" class="column frame-1-c"><div id="frameAY99JC_left_temp" class="move-span temp"></div><?php block_display('2226');?><?php block_display('2227');?><?php block_display('2228');?><?php block_display('2229');?><?php block_display('2230');?><?php block_display('2231');?><?php block_display('2232');?><?php block_display('2233');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framem9GzWg" class="frame move-span cl frame-1"><div id="framem9GzWg_left" class="column frame-1-c"><div id="framem9GzWg_left_temp" class="move-span temp"></div><?php block_display('2236');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
