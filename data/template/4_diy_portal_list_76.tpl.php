<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_76');
block_get('2630,2633,2631,2622,2623,2624,2625,2626,2627,2628,2629,2632');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framemr8WQc" class="cl_frame_bm frame move-span cl frame-1"><div id="framemr8WQc_left" class="column frame-1-c"><div id="framemr8WQc_left_temp" class="move-span temp"></div><?php block_display('2630');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2623 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2625 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2627 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2630 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameRNqCUw {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameY0CXcx" class="frame move-span cl frame-1"><div id="frameY0CXcx_left" class="column frame-1-c"><div id="frameY0CXcx_left_temp" class="move-span temp"></div><?php block_display('2633');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameRNqCUw" class=" frame move-span cl frame-1"><div id="frameRNqCUw_left" class="column frame-1-c"><div id="frameRNqCUw_left_temp" class="move-span temp"></div><?php block_display('2631');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameL7lLhc" class="cl_frame_bm frame move-span cl frame-1"><div id="frameL7lLhc_left" class="column frame-1-c"><div id="frameL7lLhc_left_temp" class="move-span temp"></div><?php block_display('2622');?><?php block_display('2623');?><?php block_display('2624');?><?php block_display('2625');?><?php block_display('2626');?><?php block_display('2627');?><?php block_display('2628');?><?php block_display('2629');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameoQwwSL" class="frame move-span cl frame-1"><div id="frameoQwwSL_left" class="column frame-1-c"><div id="frameoQwwSL_left_temp" class="move-span temp"></div><?php block_display('2632');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
