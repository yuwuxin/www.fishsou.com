<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_89');
block_get('2342,2345,2343,2334,2335,2336,2337,2338,2339,2340,2341,2344');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameZYnjAs" class="cl_frame_bm frame move-span cl frame-1"><div id="frameZYnjAs_left" class="column frame-1-c"><div id="frameZYnjAs_left_temp" class="move-span temp"></div><?php block_display('2342');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2335 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2337 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2339 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2342 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framepJRj5J {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameipycoo" class="frame move-span cl frame-1"><div id="frameipycoo_left" class="column frame-1-c"><div id="frameipycoo_left_temp" class="move-span temp"></div><?php block_display('2345');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framepJRj5J" class=" frame move-span cl frame-1"><div id="framepJRj5J_left" class="column frame-1-c"><div id="framepJRj5J_left_temp" class="move-span temp"></div><?php block_display('2343');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framef4JBTj" class="cl_frame_bm frame move-span cl frame-1"><div id="framef4JBTj_left" class="column frame-1-c"><div id="framef4JBTj_left_temp" class="move-span temp"></div><?php block_display('2334');?><?php block_display('2335');?><?php block_display('2336');?><?php block_display('2337');?><?php block_display('2338');?><?php block_display('2339');?><?php block_display('2340');?><?php block_display('2341');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameO2BBrF" class="frame move-span cl frame-1"><div id="frameO2BBrF_left" class="column frame-1-c"><div id="frameO2BBrF_left_temp" class="move-span temp"></div><?php block_display('2344');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
