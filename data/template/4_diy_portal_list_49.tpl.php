<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_49');
block_get('2774,2777,2775,2766,2767,2768,2769,2770,2771,2772,2773,2776');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framejFI8fN" class="cl_frame_bm frame move-span cl frame-1"><div id="framejFI8fN_left" class="column frame-1-c"><div id="framejFI8fN_left_temp" class="move-span temp"></div><?php block_display('2774');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2767 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2769 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2771 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2774 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameGjSVj3 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameE91Wnh" class="frame move-span cl frame-1"><div id="frameE91Wnh_left" class="column frame-1-c"><div id="frameE91Wnh_left_temp" class="move-span temp"></div><?php block_display('2777');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameGjSVj3" class=" frame move-span cl frame-1"><div id="frameGjSVj3_left" class="column frame-1-c"><div id="frameGjSVj3_left_temp" class="move-span temp"></div><?php block_display('2775');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameUcFeNu" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUcFeNu_left" class="column frame-1-c"><div id="frameUcFeNu_left_temp" class="move-span temp"></div><?php block_display('2766');?><?php block_display('2767');?><?php block_display('2768');?><?php block_display('2769');?><?php block_display('2770');?><?php block_display('2771');?><?php block_display('2772');?><?php block_display('2773');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameZ8CAtD" class="frame move-span cl frame-1"><div id="frameZ8CAtD_left" class="column frame-1-c"><div id="frameZ8CAtD_left_temp" class="move-span temp"></div><?php block_display('2776');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
