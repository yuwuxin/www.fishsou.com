<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_86');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_86.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527845883, 'diy', './data/template/4_diy_portal_view_86.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_86')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_86.htm', './template/default/common/seccheck.htm', 1527845883, 'diy', './data/template/4_diy_portal_view_86.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_86')
;
block_get('3338,3341,3339,3330,3331,3332,3333,3334,3335,3336,3337,3340');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameQqM4Ot" class="frame move-span cl frame-1"><div id="frameQqM4Ot_left" class="column frame-1-c"><div id="frameQqM4Ot_left_temp" class="move-span temp"></div></div></div><div id="framed4Sn4F" class="cl_frame_bm frame move-span cl frame-1"><div id="framed4Sn4F_left" class="column frame-1-c"><div id="framed4Sn4F_left_temp" class="move-span temp"></div><?php block_display('3338');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3331 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3333 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3335 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3338 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framey1xQb6 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameUX8Ee5" class="frame move-span cl frame-1"><div id="frameUX8Ee5_left" class="column frame-1-c"><div id="frameUX8Ee5_left_temp" class="move-span temp"></div><?php block_display('3341');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framey1xQb6" class=" frame move-span cl frame-1"><div id="framey1xQb6_left" class="column frame-1-c"><div id="framey1xQb6_left_temp" class="move-span temp"></div><?php block_display('3339');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framexwggeh" class="cl_frame_bm frame move-span cl frame-1"><div id="framexwggeh_left" class="column frame-1-c"><div id="framexwggeh_left_temp" class="move-span temp"></div><?php block_display('3330');?><?php block_display('3331');?><?php block_display('3332');?><?php block_display('3333');?><?php block_display('3334');?><?php block_display('3335');?><?php block_display('3336');?><?php block_display('3337');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framepb8EZG" class="frame move-span cl frame-1"><div id="framepb8EZG_left" class="column frame-1-c"><div id="framepb8EZG_left_temp" class="move-span temp"></div><?php block_display('3340');?></div></div></div><!--[/diy]-->
</div>
