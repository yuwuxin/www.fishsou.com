...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1527847069, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/zvis_005', 'common/header_portal_list')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1527847069, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/zvis_005', 'common/header_portal_list')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1527847069, '3', './data/template/3_3_common_header_portal_list.tpl.php', './template/zvis_005', 'common/header_portal_list')
;?>
