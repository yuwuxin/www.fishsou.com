<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_83');
block_get('2246,2249,2247,2238,2239,2240,2241,2242,2243,2244,2245,2248');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framejxH5O2" class="cl_frame_bm frame move-span cl frame-1"><div id="framejxH5O2_left" class="column frame-1-c"><div id="framejxH5O2_left_temp" class="move-span temp"></div><?php block_display('2246');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2239 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2241 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2243 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2246 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framen1urVz {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameigEA1E" class="frame move-span cl frame-1"><div id="frameigEA1E_left" class="column frame-1-c"><div id="frameigEA1E_left_temp" class="move-span temp"></div><?php block_display('2249');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framen1urVz" class=" frame move-span cl frame-1"><div id="framen1urVz_left" class="column frame-1-c"><div id="framen1urVz_left_temp" class="move-span temp"></div><?php block_display('2247');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framebs3O44" class="cl_frame_bm frame move-span cl frame-1"><div id="framebs3O44_left" class="column frame-1-c"><div id="framebs3O44_left_temp" class="move-span temp"></div><?php block_display('2238');?><?php block_display('2239');?><?php block_display('2240');?><?php block_display('2241');?><?php block_display('2242');?><?php block_display('2243');?><?php block_display('2244');?><?php block_display('2245');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameT0mbvZ" class="frame move-span cl frame-1"><div id="frameT0mbvZ_left" class="column frame-1-c"><div id="frameT0mbvZ_left_temp" class="move-span temp"></div><?php block_display('2248');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
