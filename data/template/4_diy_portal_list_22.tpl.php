<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_22');
block_get('2138,2141,2139,2130,2131,2132,2133,2134,2135,2136,2137,2140');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framer1IlL9" class="cl_frame_bm frame move-span cl frame-1"><div id="framer1IlL9_left" class="column frame-1-c"><div id="framer1IlL9_left_temp" class="move-span temp"></div><?php block_display('2138');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2131 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2133 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2135 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2138 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameIYjwGS {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameKC83HR" class="frame move-span cl frame-1"><div id="frameKC83HR_left" class="column frame-1-c"><div id="frameKC83HR_left_temp" class="move-span temp"></div><?php block_display('2141');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameIYjwGS" class=" frame move-span cl frame-1"><div id="frameIYjwGS_left" class="column frame-1-c"><div id="frameIYjwGS_left_temp" class="move-span temp"></div><?php block_display('2139');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameC5MsRX" class="cl_frame_bm frame move-span cl frame-1"><div id="frameC5MsRX_left" class="column frame-1-c"><div id="frameC5MsRX_left_temp" class="move-span temp"></div><?php block_display('2130');?><?php block_display('2131');?><?php block_display('2132');?><?php block_display('2133');?><?php block_display('2134');?><?php block_display('2135');?><?php block_display('2136');?><?php block_display('2137');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameNBQhHH" class="frame move-span cl frame-1"><div id="frameNBQhHH_left" class="column frame-1-c"><div id="frameNBQhHH_left_temp" class="move-span temp"></div><?php block_display('2140');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
