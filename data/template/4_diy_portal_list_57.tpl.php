<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_57');
block_get('2870,2873,2871,2862,2863,2864,2865,2866,2867,2868,2869,2872');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameqd5k5H" class="cl_frame_bm frame move-span cl frame-1"><div id="frameqd5k5H_left" class="column frame-1-c"><div id="frameqd5k5H_left_temp" class="move-span temp"></div><?php block_display('2870');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2863 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2865 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2867 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2870 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameIGmlKI {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameP791hO" class="frame move-span cl frame-1"><div id="frameP791hO_left" class="column frame-1-c"><div id="frameP791hO_left_temp" class="move-span temp"></div><?php block_display('2873');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameIGmlKI" class=" frame move-span cl frame-1"><div id="frameIGmlKI_left" class="column frame-1-c"><div id="frameIGmlKI_left_temp" class="move-span temp"></div><?php block_display('2871');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framecgb8hg" class="cl_frame_bm frame move-span cl frame-1"><div id="framecgb8hg_left" class="column frame-1-c"><div id="framecgb8hg_left_temp" class="move-span temp"></div><?php block_display('2862');?><?php block_display('2863');?><?php block_display('2864');?><?php block_display('2865');?><?php block_display('2866');?><?php block_display('2867');?><?php block_display('2868');?><?php block_display('2869');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameNTt5O4" class="frame move-span cl frame-1"><div id="frameNTt5O4_left" class="column frame-1-c"><div id="frameNTt5O4_left_temp" class="move-span temp"></div><?php block_display('2872');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
