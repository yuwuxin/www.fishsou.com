<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_12');
block_get('2090,2093,2091,2082,2083,2084,2085,2086,2087,2088,2089,2092');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameQ7aHrW" class="cl_frame_bm frame move-span cl frame-1"><div id="frameQ7aHrW_left" class="column frame-1-c"><div id="frameQ7aHrW_left_temp" class="move-span temp"></div><?php block_display('2090');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2083 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2085 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2087 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2090 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framewpWa55 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameYPgTzg" class="frame move-span cl frame-1"><div id="frameYPgTzg_left" class="column frame-1-c"><div id="frameYPgTzg_left_temp" class="move-span temp"></div><?php block_display('2093');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framewpWa55" class=" frame move-span cl frame-1"><div id="framewpWa55_left" class="column frame-1-c"><div id="framewpWa55_left_temp" class="move-span temp"></div><?php block_display('2091');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameEnSLqQ" class="cl_frame_bm frame move-span cl frame-1"><div id="frameEnSLqQ_left" class="column frame-1-c"><div id="frameEnSLqQ_left_temp" class="move-span temp"></div><?php block_display('2082');?><?php block_display('2083');?><?php block_display('2084');?><?php block_display('2085');?><?php block_display('2086');?><?php block_display('2087');?><?php block_display('2088');?><?php block_display('2089');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framettuzU8" class="frame move-span cl frame-1"><div id="framettuzU8_left" class="column frame-1-c"><div id="framettuzU8_left_temp" class="move-span temp"></div><?php block_display('2092');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
