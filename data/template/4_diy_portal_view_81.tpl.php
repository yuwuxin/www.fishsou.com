<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_81');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_81.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844109, 'diy', './data/template/4_diy_portal_view_81.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_81')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_81.htm', './template/default/common/seccheck.htm', 1527844109, 'diy', './data/template/4_diy_portal_view_81.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_81')
;
block_get('3254,3257,3255,3246,3247,3248,3249,3250,3251,3252,3253,3256');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameJj8HTg" class="frame move-span cl frame-1"><div id="frameJj8HTg_left" class="column frame-1-c"><div id="frameJj8HTg_left_temp" class="move-span temp"></div></div></div><div id="frameoK9V7P" class="cl_frame_bm frame move-span cl frame-1"><div id="frameoK9V7P_left" class="column frame-1-c"><div id="frameoK9V7P_left_temp" class="move-span temp"></div><?php block_display('3254');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3247 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3249 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3251 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3254 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameCPf9KG {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="framehvaU5e" class="frame move-span cl frame-1"><div id="framehvaU5e_left" class="column frame-1-c"><div id="framehvaU5e_left_temp" class="move-span temp"></div><?php block_display('3257');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameCPf9KG" class=" frame move-span cl frame-1"><div id="frameCPf9KG_left" class="column frame-1-c"><div id="frameCPf9KG_left_temp" class="move-span temp"></div><?php block_display('3255');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameD1pgFp" class="cl_frame_bm frame move-span cl frame-1"><div id="frameD1pgFp_left" class="column frame-1-c"><div id="frameD1pgFp_left_temp" class="move-span temp"></div><?php block_display('3246');?><?php block_display('3247');?><?php block_display('3248');?><?php block_display('3249');?><?php block_display('3250');?><?php block_display('3251');?><?php block_display('3252');?><?php block_display('3253');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framefQjQZE" class="frame move-span cl frame-1"><div id="framefQjQZE_left" class="column frame-1-c"><div id="framefQjQZE_left_temp" class="move-span temp"></div><?php block_display('3256');?></div></div></div><!--[/diy]-->
</div>
