<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_89');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_89.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527846102, 'diy', './data/template/4_diy_portal_view_89.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_89')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_89.htm', './template/default/common/seccheck.htm', 1527846102, 'diy', './data/template/4_diy_portal_view_89.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_89')
;
block_get('3230,3233,3231,3222,3223,3224,3225,3226,3227,3228,3229,3232');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameNpWFL5" class="frame move-span cl frame-1"><div id="frameNpWFL5_left" class="column frame-1-c"><div id="frameNpWFL5_left_temp" class="move-span temp"></div></div></div><div id="frameMTMqH5" class="cl_frame_bm frame move-span cl frame-1"><div id="frameMTMqH5_left" class="column frame-1-c"><div id="frameMTMqH5_left_temp" class="move-span temp"></div><?php block_display('3230');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3223 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3225 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3227 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3230 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framey18GBg {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameVrzjRa" class="frame move-span cl frame-1"><div id="frameVrzjRa_left" class="column frame-1-c"><div id="frameVrzjRa_left_temp" class="move-span temp"></div><?php block_display('3233');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framey18GBg" class=" frame move-span cl frame-1"><div id="framey18GBg_left" class="column frame-1-c"><div id="framey18GBg_left_temp" class="move-span temp"></div><?php block_display('3231');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameWbXlo7" class="cl_frame_bm frame move-span cl frame-1"><div id="frameWbXlo7_left" class="column frame-1-c"><div id="frameWbXlo7_left_temp" class="move-span temp"></div><?php block_display('3222');?><?php block_display('3223');?><?php block_display('3224');?><?php block_display('3225');?><?php block_display('3226');?><?php block_display('3227');?><?php block_display('3228');?><?php block_display('3229');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameHcsasV" class="frame move-span cl frame-1"><div id="frameHcsasV_left" class="column frame-1-c"><div id="frameHcsasV_left_temp" class="move-span temp"></div><?php block_display('3232');?></div></div></div><!--[/diy]-->
</div>
