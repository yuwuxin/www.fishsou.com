<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_38');
block_get('2510,2513,2511,2502,2503,2504,2505,2506,2507,2508,2509,2512');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameCwTWII" class="cl_frame_bm frame move-span cl frame-1"><div id="frameCwTWII_left" class="column frame-1-c"><div id="frameCwTWII_left_temp" class="move-span temp"></div><?php block_display('2510');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2503 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2505 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2507 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2510 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameydb748 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameNpwOuW" class="frame move-span cl frame-1"><div id="frameNpwOuW_left" class="column frame-1-c"><div id="frameNpwOuW_left_temp" class="move-span temp"></div><?php block_display('2513');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameydb748" class=" frame move-span cl frame-1"><div id="frameydb748_left" class="column frame-1-c"><div id="frameydb748_left_temp" class="move-span temp"></div><?php block_display('2511');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameK7YRqx" class="cl_frame_bm frame move-span cl frame-1"><div id="frameK7YRqx_left" class="column frame-1-c"><div id="frameK7YRqx_left_temp" class="move-span temp"></div><?php block_display('2502');?><?php block_display('2503');?><?php block_display('2504');?><?php block_display('2505');?><?php block_display('2506');?><?php block_display('2507');?><?php block_display('2508');?><?php block_display('2509');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameZkKlGG" class="frame move-span cl frame-1"><div id="frameZkKlGG_left" class="column frame-1-c"><div id="frameZkKlGG_left_temp" class="move-span temp"></div><?php block_display('2512');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
