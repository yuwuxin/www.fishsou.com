...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1527845016, '4', './data/template/4_4_forum_forumdisplay_fastpost.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1527845016, '4', './data/template/4_4_forum_forumdisplay_fastpost.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1527845016, '4', './data/template/4_4_forum_forumdisplay_fastpost.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1527845016, '4', './data/template/4_4_forum_forumdisplay_fastpost.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay_fastpost')
;?>
