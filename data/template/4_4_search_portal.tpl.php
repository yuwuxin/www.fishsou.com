...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1527903964, '4', './data/template/4_4_search_portal.tpl.php', './template/comiis_meizhou', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1527903964, '4', './data/template/4_4_search_portal.tpl.php', './template/comiis_meizhou', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1527903964, '4', './data/template/4_4_search_portal.tpl.php', './template/comiis_meizhou', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1527903964, '4', './data/template/4_4_search_portal.tpl.php', './template/comiis_meizhou', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1527903964, '4', './data/template/4_4_search_portal.tpl.php', './template/comiis_meizhou', 'search/portal')
;?>
