<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_32');
block_get('2438,2441,2439,2430,2431,2432,2433,2434,2435,2436,2437,2440');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framesN6Y4x" class="cl_frame_bm frame move-span cl frame-1"><div id="framesN6Y4x_left" class="column frame-1-c"><div id="framesN6Y4x_left_temp" class="move-span temp"></div><?php block_display('2438');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2431 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2433 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2435 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2438 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framezf1g11 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framejdI4P5" class="frame move-span cl frame-1"><div id="framejdI4P5_left" class="column frame-1-c"><div id="framejdI4P5_left_temp" class="move-span temp"></div><?php block_display('2441');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framezf1g11" class=" frame move-span cl frame-1"><div id="framezf1g11_left" class="column frame-1-c"><div id="framezf1g11_left_temp" class="move-span temp"></div><?php block_display('2439');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameqTCYLc" class="cl_frame_bm frame move-span cl frame-1"><div id="frameqTCYLc_left" class="column frame-1-c"><div id="frameqTCYLc_left_temp" class="move-span temp"></div><?php block_display('2430');?><?php block_display('2431');?><?php block_display('2432');?><?php block_display('2433');?><?php block_display('2434');?><?php block_display('2435');?><?php block_display('2436');?><?php block_display('2437');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framersQPzq" class="frame move-span cl frame-1"><div id="framersQPzq_left" class="column frame-1-c"><div id="framersQPzq_left_temp" class="move-span temp"></div><?php block_display('2440');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
