<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_47');
block_get('2750,2753,2751,2742,2743,2744,2745,2746,2747,2748,2749,2752');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameK856zj" class="cl_frame_bm frame move-span cl frame-1"><div id="frameK856zj_left" class="column frame-1-c"><div id="frameK856zj_left_temp" class="move-span temp"></div><?php block_display('2750');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2743 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2745 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2747 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2750 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameoTr381 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameH733h4" class="frame move-span cl frame-1"><div id="frameH733h4_left" class="column frame-1-c"><div id="frameH733h4_left_temp" class="move-span temp"></div><?php block_display('2753');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameoTr381" class=" frame move-span cl frame-1"><div id="frameoTr381_left" class="column frame-1-c"><div id="frameoTr381_left_temp" class="move-span temp"></div><?php block_display('2751');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framexJHf1H" class="cl_frame_bm frame move-span cl frame-1"><div id="framexJHf1H_left" class="column frame-1-c"><div id="framexJHf1H_left_temp" class="move-span temp"></div><?php block_display('2742');?><?php block_display('2743');?><?php block_display('2744');?><?php block_display('2745');?><?php block_display('2746');?><?php block_display('2747');?><?php block_display('2748');?><?php block_display('2749');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameDJCjLt" class="frame move-span cl frame-1"><div id="frameDJCjLt_left" class="column frame-1-c"><div id="frameDJCjLt_left_temp" class="move-span temp"></div><?php block_display('2752');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
