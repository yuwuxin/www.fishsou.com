<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_60');
block_get('2906,2909,2907,2898,2899,2900,2901,2902,2903,2904,2905,2908');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framet1wKSW" class="cl_frame_bm frame move-span cl frame-1"><div id="framet1wKSW_left" class="column frame-1-c"><div id="framet1wKSW_left_temp" class="move-span temp"></div><?php block_display('2906');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2899 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2901 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2903 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2906 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameH2hhX3 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameYZZ3XQ" class="frame move-span cl frame-1"><div id="frameYZZ3XQ_left" class="column frame-1-c"><div id="frameYZZ3XQ_left_temp" class="move-span temp"></div><?php block_display('2909');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameH2hhX3" class=" frame move-span cl frame-1"><div id="frameH2hhX3_left" class="column frame-1-c"><div id="frameH2hhX3_left_temp" class="move-span temp"></div><?php block_display('2907');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framet3GXN3" class="cl_frame_bm frame move-span cl frame-1"><div id="framet3GXN3_left" class="column frame-1-c"><div id="framet3GXN3_left_temp" class="move-span temp"></div><?php block_display('2898');?><?php block_display('2899');?><?php block_display('2900');?><?php block_display('2901');?><?php block_display('2902');?><?php block_display('2903');?><?php block_display('2904');?><?php block_display('2905');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framewtNEDN" class="frame move-span cl frame-1"><div id="framewtNEDN_left" class="column frame-1-c"><div id="framewtNEDN_left_temp" class="move-span temp"></div><?php block_display('2908');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
