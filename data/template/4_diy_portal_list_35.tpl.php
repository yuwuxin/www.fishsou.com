<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_35');
block_get('2474,2477,2475,2466,2467,2468,2469,2470,2471,2472,2473,2476');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framehmtr2N" class="cl_frame_bm frame move-span cl frame-1"><div id="framehmtr2N_left" class="column frame-1-c"><div id="framehmtr2N_left_temp" class="move-span temp"></div><?php block_display('2474');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2467 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2469 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2471 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2474 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framettw7C3 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameSkhwCS" class="frame move-span cl frame-1"><div id="frameSkhwCS_left" class="column frame-1-c"><div id="frameSkhwCS_left_temp" class="move-span temp"></div><?php block_display('2477');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framettw7C3" class=" frame move-span cl frame-1"><div id="framettw7C3_left" class="column frame-1-c"><div id="framettw7C3_left_temp" class="move-span temp"></div><?php block_display('2475');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framesk3j85" class="cl_frame_bm frame move-span cl frame-1"><div id="framesk3j85_left" class="column frame-1-c"><div id="framesk3j85_left_temp" class="move-span temp"></div><?php block_display('2466');?><?php block_display('2467');?><?php block_display('2468');?><?php block_display('2469');?><?php block_display('2470');?><?php block_display('2471');?><?php block_display('2472');?><?php block_display('2473');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameFK0jvk" class="frame move-span cl frame-1"><div id="frameFK0jvk_left" class="column frame-1-c"><div id="frameFK0jvk_left_temp" class="move-span temp"></div><?php block_display('2476');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
