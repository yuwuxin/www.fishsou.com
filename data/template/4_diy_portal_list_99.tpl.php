<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_99');
block_get('2354,2357,2355,2346,2347,2348,2349,2350,2351,2352,2353,2356');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameO1x0qD" class="cl_frame_bm frame move-span cl frame-1"><div id="frameO1x0qD_left" class="column frame-1-c"><div id="frameO1x0qD_left_temp" class="move-span temp"></div><?php block_display('2354');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2347 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2349 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2351 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2354 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framekXxeX3 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameoi9b5Z" class="frame move-span cl frame-1"><div id="frameoi9b5Z_left" class="column frame-1-c"><div id="frameoi9b5Z_left_temp" class="move-span temp"></div><?php block_display('2357');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framekXxeX3" class=" frame move-span cl frame-1"><div id="framekXxeX3_left" class="column frame-1-c"><div id="framekXxeX3_left_temp" class="move-span temp"></div><?php block_display('2355');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameY4ZQ62" class="cl_frame_bm frame move-span cl frame-1"><div id="frameY4ZQ62_left" class="column frame-1-c"><div id="frameY4ZQ62_left_temp" class="move-span temp"></div><?php block_display('2346');?><?php block_display('2347');?><?php block_display('2348');?><?php block_display('2349');?><?php block_display('2350');?><?php block_display('2351');?><?php block_display('2352');?><?php block_display('2353');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framex691za" class="frame move-span cl frame-1"><div id="framex691za_left" class="column frame-1-c"><div id="framex691za_left_temp" class="move-span temp"></div><?php block_display('2356');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
