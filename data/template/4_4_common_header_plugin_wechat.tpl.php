...
0
|| checktplrefresh('./template/comiis_meizhou/common/header.htm', './template/default/common/header_common.htm', 1527911862, '4', './data/template/4_4_common_header_plugin_wechat.tpl.php', './template/comiis_meizhou', 'common/header_plugin_wechat')
|| checktplrefresh('./template/comiis_meizhou/common/header.htm', './template/comiis_meizhou/common/comiis_user.htm', 1527911862, '4', './data/template/4_4_common_header_plugin_wechat.tpl.php', './template/comiis_meizhou', 'common/header_plugin_wechat')
|| checktplrefresh('./template/comiis_meizhou/common/header.htm', './template/default/common/header_qmenu.htm', 1527911862, '4', './data/template/4_4_common_header_plugin_wechat.tpl.php', './template/comiis_meizhou', 'common/header_plugin_wechat')
|| checktplrefresh('./template/comiis_meizhou/common/header.htm', './template/comiis_meizhou/common/comiis_navss.htm', 1527911862, '4', './data/template/4_4_common_header_plugin_wechat.tpl.php', './template/comiis_meizhou', 'common/header_plugin_wechat')
|| checktplrefresh('./template/comiis_meizhou/common/header.htm', './template/default/common/pubsearchform.htm', 1527911862, '4', './data/template/4_4_common_header_plugin_wechat.tpl.php', './template/comiis_meizhou', 'common/header_plugin_wechat')
;?>
