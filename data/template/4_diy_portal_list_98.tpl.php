<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_98');
block_get('2678,2681,2679,2670,2671,2672,2673,2674,2675,2676,2677,2680');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameh41EIC" class="cl_frame_bm frame move-span cl frame-1"><div id="frameh41EIC_left" class="column frame-1-c"><div id="frameh41EIC_left_temp" class="move-span temp"></div><?php block_display('2678');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2671 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2673 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2675 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2678 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framenclMLZ {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameIFRb1e" class="frame move-span cl frame-1"><div id="frameIFRb1e_left" class="column frame-1-c"><div id="frameIFRb1e_left_temp" class="move-span temp"></div><?php block_display('2681');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framenclMLZ" class=" frame move-span cl frame-1"><div id="framenclMLZ_left" class="column frame-1-c"><div id="framenclMLZ_left_temp" class="move-span temp"></div><?php block_display('2679');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framewh6Okj" class="cl_frame_bm frame move-span cl frame-1"><div id="framewh6Okj_left" class="column frame-1-c"><div id="framewh6Okj_left_temp" class="move-span temp"></div><?php block_display('2670');?><?php block_display('2671');?><?php block_display('2672');?><?php block_display('2673');?><?php block_display('2674');?><?php block_display('2675');?><?php block_display('2676');?><?php block_display('2677');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameBfffE8" class="frame move-span cl frame-1"><div id="frameBfffE8_left" class="column frame-1-c"><div id="frameBfffE8_left_temp" class="move-span temp"></div><?php block_display('2680');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
