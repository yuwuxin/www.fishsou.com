<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_21');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_21.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527848574, 'diy', './data/template/4_diy_portal_view_21.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_21')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_21.htm', './template/default/common/seccheck.htm', 1527848574, 'diy', './data/template/4_diy_portal_view_21.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_21')
;
block_get('3158,3161,3159,3150,3151,3152,3153,3154,3155,3156,3157,3160');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameE2y9fZ" class="frame move-span cl frame-1"><div id="frameE2y9fZ_left" class="column frame-1-c"><div id="frameE2y9fZ_left_temp" class="move-span temp"></div></div></div><div id="frameUqyG5w" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUqyG5w_left" class="column frame-1-c"><div id="frameUqyG5w_left_temp" class="move-span temp"></div><?php block_display('3158');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3151 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3153 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3155 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3158 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framecc3235 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameHIFMPg" class="frame move-span cl frame-1"><div id="frameHIFMPg_left" class="column frame-1-c"><div id="frameHIFMPg_left_temp" class="move-span temp"></div><?php block_display('3161');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framecc3235" class=" frame move-span cl frame-1"><div id="framecc3235_left" class="column frame-1-c"><div id="framecc3235_left_temp" class="move-span temp"></div><?php block_display('3159');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameNI43m1" class="cl_frame_bm frame move-span cl frame-1"><div id="frameNI43m1_left" class="column frame-1-c"><div id="frameNI43m1_left_temp" class="move-span temp"></div><?php block_display('3150');?><?php block_display('3151');?><?php block_display('3152');?><?php block_display('3153');?><?php block_display('3154');?><?php block_display('3155');?><?php block_display('3156');?><?php block_display('3157');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framemyOs5P" class="frame move-span cl frame-1"><div id="framemyOs5P_left" class="column frame-1-c"><div id="framemyOs5P_left_temp" class="move-span temp"></div><?php block_display('3160');?></div></div></div><!--[/diy]-->
</div>
