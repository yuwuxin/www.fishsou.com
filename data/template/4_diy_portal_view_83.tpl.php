<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_83');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_83.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527845846, 'diy', './data/template/4_diy_portal_view_83.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_83')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_83.htm', './template/default/common/seccheck.htm', 1527845846, 'diy', './data/template/4_diy_portal_view_83.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_83')
;
block_get('3278,3281,3279,3270,3271,3272,3273,3274,3275,3276,3277,3280');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameYay2zB" class="frame move-span cl frame-1"><div id="frameYay2zB_left" class="column frame-1-c"><div id="frameYay2zB_left_temp" class="move-span temp"></div></div></div><div id="framen0Ky45" class="cl_frame_bm frame move-span cl frame-1"><div id="framen0Ky45_left" class="column frame-1-c"><div id="framen0Ky45_left_temp" class="move-span temp"></div><?php block_display('3278');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3271 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3273 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3275 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3278 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framebPta86 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="framezRg777" class="frame move-span cl frame-1"><div id="framezRg777_left" class="column frame-1-c"><div id="framezRg777_left_temp" class="move-span temp"></div><?php block_display('3281');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framebPta86" class=" frame move-span cl frame-1"><div id="framebPta86_left" class="column frame-1-c"><div id="framebPta86_left_temp" class="move-span temp"></div><?php block_display('3279');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameFkFWgw" class="cl_frame_bm frame move-span cl frame-1"><div id="frameFkFWgw_left" class="column frame-1-c"><div id="frameFkFWgw_left_temp" class="move-span temp"></div><?php block_display('3270');?><?php block_display('3271');?><?php block_display('3272');?><?php block_display('3273');?><?php block_display('3274');?><?php block_display('3275');?><?php block_display('3276');?><?php block_display('3277');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameLX9IEn" class="frame move-span cl frame-1"><div id="frameLX9IEn_left" class="column frame-1-c"><div id="frameLX9IEn_left_temp" class="move-span temp"></div><?php block_display('3280');?></div></div></div><!--[/diy]-->
</div>
