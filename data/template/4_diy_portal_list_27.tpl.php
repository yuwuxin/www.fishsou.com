<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_27');
block_get('2378,2381,2379,2370,2371,2372,2373,2374,2375,2376,2377,2380');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameCn4Wa1" class="cl_frame_bm frame move-span cl frame-1"><div id="frameCn4Wa1_left" class="column frame-1-c"><div id="frameCn4Wa1_left_temp" class="move-span temp"></div><?php block_display('2378');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2371 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2373 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2375 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2378 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framecG1JGc {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameA103VY" class="frame move-span cl frame-1"><div id="frameA103VY_left" class="column frame-1-c"><div id="frameA103VY_left_temp" class="move-span temp"></div><?php block_display('2381');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framecG1JGc" class=" frame move-span cl frame-1"><div id="framecG1JGc_left" class="column frame-1-c"><div id="framecG1JGc_left_temp" class="move-span temp"></div><?php block_display('2379');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameVp8gim" class="cl_frame_bm frame move-span cl frame-1"><div id="frameVp8gim_left" class="column frame-1-c"><div id="frameVp8gim_left_temp" class="move-span temp"></div><?php block_display('2370');?><?php block_display('2371');?><?php block_display('2372');?><?php block_display('2373');?><?php block_display('2374');?><?php block_display('2375');?><?php block_display('2376');?><?php block_display('2377');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framejVv1Ke" class="frame move-span cl frame-1"><div id="framejVv1Ke_left" class="column frame-1-c"><div id="framejVv1Ke_left_temp" class="move-span temp"></div><?php block_display('2380');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
