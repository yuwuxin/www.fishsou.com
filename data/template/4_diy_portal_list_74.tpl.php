<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_74');
block_get('2606,2609,2607,2598,2599,2600,2601,2602,2603,2604,2605,2608');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameJr0clQ" class="cl_frame_bm frame move-span cl frame-1"><div id="frameJr0clQ_left" class="column frame-1-c"><div id="frameJr0clQ_left_temp" class="move-span temp"></div><?php block_display('2606');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2599 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2601 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2603 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2606 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameJWzhOw {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameb2CN2W" class="frame move-span cl frame-1"><div id="frameb2CN2W_left" class="column frame-1-c"><div id="frameb2CN2W_left_temp" class="move-span temp"></div><?php block_display('2609');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameJWzhOw" class=" frame move-span cl frame-1"><div id="frameJWzhOw_left" class="column frame-1-c"><div id="frameJWzhOw_left_temp" class="move-span temp"></div><?php block_display('2607');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framekbG59g" class="cl_frame_bm frame move-span cl frame-1"><div id="framekbG59g_left" class="column frame-1-c"><div id="framekbG59g_left_temp" class="move-span temp"></div><?php block_display('2598');?><?php block_display('2599');?><?php block_display('2600');?><?php block_display('2601');?><?php block_display('2602');?><?php block_display('2603');?><?php block_display('2604');?><?php block_display('2605');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameJU5HyL" class="frame move-span cl frame-1"><div id="frameJU5HyL_left" class="column frame-1-c"><div id="frameJU5HyL_left_temp" class="move-span temp"></div><?php block_display('2608');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
