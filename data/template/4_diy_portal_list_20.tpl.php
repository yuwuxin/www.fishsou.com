<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_20');
block_get('2114,2117,2115,2106,2107,2108,2109,2110,2111,2112,2113,2116');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framey94bZR" class="cl_frame_bm frame move-span cl frame-1"><div id="framey94bZR_left" class="column frame-1-c"><div id="framey94bZR_left_temp" class="move-span temp"></div><?php block_display('2114');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2107 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2109 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2111 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2114 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameY6F9e0 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framerDBHzZ" class="frame move-span cl frame-1"><div id="framerDBHzZ_left" class="column frame-1-c"><div id="framerDBHzZ_left_temp" class="move-span temp"></div><?php block_display('2117');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameY6F9e0" class=" frame move-span cl frame-1"><div id="frameY6F9e0_left" class="column frame-1-c"><div id="frameY6F9e0_left_temp" class="move-span temp"></div><?php block_display('2115');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framed2v8wE" class="cl_frame_bm frame move-span cl frame-1"><div id="framed2v8wE_left" class="column frame-1-c"><div id="framed2v8wE_left_temp" class="move-span temp"></div><?php block_display('2106');?><?php block_display('2107');?><?php block_display('2108');?><?php block_display('2109');?><?php block_display('2110');?><?php block_display('2111');?><?php block_display('2112');?><?php block_display('2113');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameH0uetq" class="frame move-span cl frame-1"><div id="frameH0uetq_left" class="column frame-1-c"><div id="frameH0uetq_left_temp" class="move-span temp"></div><?php block_display('2116');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
