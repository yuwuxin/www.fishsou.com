<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_10');
block_get('1898,1901,1899,1890,1891,1892,1893,1894,1895,1896,1897,1900');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framentrtff" class="cl_frame_bm frame move-span cl frame-1"><div id="framentrtff_left" class="column frame-1-c"><div id="framentrtff_left_temp" class="move-span temp"></div><?php block_display('1898');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1891 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1893 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1895 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1898 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameO2pt6T {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameaQaFWR" class="frame move-span cl frame-1"><div id="frameaQaFWR_left" class="column frame-1-c"><div id="frameaQaFWR_left_temp" class="move-span temp"></div><?php block_display('1901');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameO2pt6T" class=" frame move-span cl frame-1"><div id="frameO2pt6T_left" class="column frame-1-c"><div id="frameO2pt6T_left_temp" class="move-span temp"></div><?php block_display('1899');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameE3xa80" class="cl_frame_bm frame move-span cl frame-1"><div id="frameE3xa80_left" class="column frame-1-c"><div id="frameE3xa80_left_temp" class="move-span temp"></div><?php block_display('1890');?><?php block_display('1891');?><?php block_display('1892');?><?php block_display('1893');?><?php block_display('1894');?><?php block_display('1895');?><?php block_display('1896');?><?php block_display('1897');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameAX5WJB" class="frame move-span cl frame-1"><div id="frameAX5WJB_left" class="column frame-1-c"><div id="frameAX5WJB_left_temp" class="move-span temp"></div><?php block_display('1900');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
