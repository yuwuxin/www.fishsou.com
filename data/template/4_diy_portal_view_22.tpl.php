<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_22');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_22.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527856502, 'diy', './data/template/4_diy_portal_view_22.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_22')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_22.htm', './template/default/common/seccheck.htm', 1527856502, 'diy', './data/template/4_diy_portal_view_22.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_22')
;
block_get('3170,3173,3171,3162,3163,3164,3165,3166,3167,3168,3169,3172');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameMAct69" class="frame move-span cl frame-1"><div id="frameMAct69_left" class="column frame-1-c"><div id="frameMAct69_left_temp" class="move-span temp"></div></div></div><div id="frameA0NOl4" class="cl_frame_bm frame move-span cl frame-1"><div id="frameA0NOl4_left" class="column frame-1-c"><div id="frameA0NOl4_left_temp" class="move-span temp"></div><?php block_display('3170');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3163 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3165 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3167 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3170 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameYWPiKk {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameQUBd1M" class="frame move-span cl frame-1"><div id="frameQUBd1M_left" class="column frame-1-c"><div id="frameQUBd1M_left_temp" class="move-span temp"></div><?php block_display('3173');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameYWPiKk" class=" frame move-span cl frame-1"><div id="frameYWPiKk_left" class="column frame-1-c"><div id="frameYWPiKk_left_temp" class="move-span temp"></div><?php block_display('3171');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frametWnG62" class="cl_frame_bm frame move-span cl frame-1"><div id="frametWnG62_left" class="column frame-1-c"><div id="frametWnG62_left_temp" class="move-span temp"></div><?php block_display('3162');?><?php block_display('3163');?><?php block_display('3164');?><?php block_display('3165');?><?php block_display('3166');?><?php block_display('3167');?><?php block_display('3168');?><?php block_display('3169');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameG646cf" class="frame move-span cl frame-1"><div id="frameG646cf_left" class="column frame-1-c"><div id="frameG646cf_left_temp" class="move-span temp"></div><?php block_display('3172');?></div></div></div><!--[/diy]-->
</div>
