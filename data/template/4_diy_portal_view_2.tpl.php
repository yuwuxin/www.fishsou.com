...
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_2.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844025, 'diy', './data/template/4_diy_portal_view_2.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_2')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_2.htm', './template/default/common/seccheck.htm', 1527844025, 'diy', './data/template/4_diy_portal_view_2.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_2')
;
block_get('1644,1636,919');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framexsb1sF" class="cl_frame_bm frame move-span cl frame-1"><div id="framexsb1sF_left" class="column frame-1-c"><div id="framexsb1sF_left_temp" class="move-span temp"></div><?php block_display('1644');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#frame166sUZ {  border:#000000 !important;margin:0px !important;}#portal_block_919 {  border:#000000 !important;margin:0px !important;}#portal_block_919 .dxb_bc {  margin-top:0px !important;margin-bottom:0px !important;margin-left:0px !important;}#portal_block_1644 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framej6VMHQ" class="xfs xfs_nbd frame move-span cl frame-1"><div id="framej6VMHQ_left" class="column frame-1-c"><div id="framej6VMHQ_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameYTlmgk" class="cl_frame_bm frame move-span cl frame-1"><div id="frameYTlmgk_left" class="column frame-1-c"><div id="frameYTlmgk_left_temp" class="move-span temp"></div><?php block_display('1636');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frame166sUZ" class="xfs xfs_1 frame move-span cl frame-1"><div id="frame166sUZ_left" class="column frame-1-c"><div id="frame166sUZ_left_temp" class="move-span temp"></div><?php block_display('919');?></div></div></div><!--[/diy]-->
</div>
