<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_72');
block_get('2582,2585,2583,2574,2575,2576,2577,2578,2579,2580,2581,2584');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameAJkKvo" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAJkKvo_left" class="column frame-1-c"><div id="frameAJkKvo_left_temp" class="move-span temp"></div><?php block_display('2582');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2575 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2577 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2579 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2582 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameGF79j2 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameF5aXdn" class="frame move-span cl frame-1"><div id="frameF5aXdn_left" class="column frame-1-c"><div id="frameF5aXdn_left_temp" class="move-span temp"></div><?php block_display('2585');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameGF79j2" class=" frame move-span cl frame-1"><div id="frameGF79j2_left" class="column frame-1-c"><div id="frameGF79j2_left_temp" class="move-span temp"></div><?php block_display('2583');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framejUz114" class="cl_frame_bm frame move-span cl frame-1"><div id="framejUz114_left" class="column frame-1-c"><div id="framejUz114_left_temp" class="move-span temp"></div><?php block_display('2574');?><?php block_display('2575');?><?php block_display('2576');?><?php block_display('2577');?><?php block_display('2578');?><?php block_display('2579');?><?php block_display('2580');?><?php block_display('2581');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameT998K0" class="frame move-span cl frame-1"><div id="frameT998K0_left" class="column frame-1-c"><div id="frameT998K0_left_temp" class="move-span temp"></div><?php block_display('2584');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
