<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_55');
block_get('2846,2849,2847,2838,2839,2840,2841,2842,2843,2844,2845,2848');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameIEQ023" class="cl_frame_bm frame move-span cl frame-1"><div id="frameIEQ023_left" class="column frame-1-c"><div id="frameIEQ023_left_temp" class="move-span temp"></div><?php block_display('2846');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2839 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2841 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2843 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2846 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framek1yaO3 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framemcD2Aa" class="frame move-span cl frame-1"><div id="framemcD2Aa_left" class="column frame-1-c"><div id="framemcD2Aa_left_temp" class="move-span temp"></div><?php block_display('2849');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framek1yaO3" class=" frame move-span cl frame-1"><div id="framek1yaO3_left" class="column frame-1-c"><div id="framek1yaO3_left_temp" class="move-span temp"></div><?php block_display('2847');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frametSLs7C" class="cl_frame_bm frame move-span cl frame-1"><div id="frametSLs7C_left" class="column frame-1-c"><div id="frametSLs7C_left_temp" class="move-span temp"></div><?php block_display('2838');?><?php block_display('2839');?><?php block_display('2840');?><?php block_display('2841');?><?php block_display('2842');?><?php block_display('2843');?><?php block_display('2844');?><?php block_display('2845');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameDlsC2s" class="frame move-span cl frame-1"><div id="frameDlsC2s_left" class="column frame-1-c"><div id="frameDlsC2s_left_temp" class="move-span temp"></div><?php block_display('2848');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
