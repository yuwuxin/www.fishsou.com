...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1527847334, '4', './data/template/4_4_member_register.tpl.php', './template/comiis_meizhou', 'member/register')
