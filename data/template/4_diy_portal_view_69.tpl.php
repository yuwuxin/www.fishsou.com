<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_69');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_69.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844003, 'diy', './data/template/4_diy_portal_view_69.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_69')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_69.htm', './template/default/common/seccheck.htm', 1527844003, 'diy', './data/template/4_diy_portal_view_69.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_69')
;
block_get('1583,1575,1576,1577,1578,1579,1580,1581,1582');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameyjSXyO" class="cl_frame_bm frame move-span cl frame-1"><div id="frameyjSXyO_left" class="column frame-1-c"><div id="frameyjSXyO_left_temp" class="move-span temp"></div><?php block_display('1583');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1576 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1578 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1580 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1583 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
<div class="wp">
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framekW0XEG" class="cl_frame_bm frame move-span cl frame-1"><div id="framekW0XEG_left" class="column frame-1-c"><div id="framekW0XEG_left_temp" class="move-span temp"></div><?php block_display('1575');?><?php block_display('1576');?><?php block_display('1577');?><?php block_display('1578');?><?php block_display('1579');?><?php block_display('1580');?><?php block_display('1581');?><?php block_display('1582');?></div></div></div><!--[/diy]-->
<div class="drag">
