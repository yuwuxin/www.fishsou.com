<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_73');
block_get('2594,2597,2595,2586,2587,2588,2589,2590,2591,2592,2593,2596');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameKta3M1" class="cl_frame_bm frame move-span cl frame-1"><div id="frameKta3M1_left" class="column frame-1-c"><div id="frameKta3M1_left_temp" class="move-span temp"></div><?php block_display('2594');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2587 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2589 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2591 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2594 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameS8bI8J {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameEY3gtn" class="frame move-span cl frame-1"><div id="frameEY3gtn_left" class="column frame-1-c"><div id="frameEY3gtn_left_temp" class="move-span temp"></div><?php block_display('2597');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameS8bI8J" class=" frame move-span cl frame-1"><div id="frameS8bI8J_left" class="column frame-1-c"><div id="frameS8bI8J_left_temp" class="move-span temp"></div><?php block_display('2595');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framein6wf5" class="cl_frame_bm frame move-span cl frame-1"><div id="framein6wf5_left" class="column frame-1-c"><div id="framein6wf5_left_temp" class="move-span temp"></div><?php block_display('2586');?><?php block_display('2587');?><?php block_display('2588');?><?php block_display('2589');?><?php block_display('2590');?><?php block_display('2591');?><?php block_display('2592');?><?php block_display('2593');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameb7jU27" class="frame move-span cl frame-1"><div id="frameb7jU27_left" class="column frame-1-c"><div id="frameb7jU27_left_temp" class="move-span temp"></div><?php block_display('2596');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
