<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_92');
block_get('3026,3029,3027,3018,3019,3020,3021,3022,3023,3024,3025,3028');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framexeriaH" class="cl_frame_bm frame move-span cl frame-1"><div id="framexeriaH_left" class="column frame-1-c"><div id="framexeriaH_left_temp" class="move-span temp"></div><?php block_display('3026');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3019 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3021 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3023 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3026 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameM3peeN {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameHHPy8P" class="frame move-span cl frame-1"><div id="frameHHPy8P_left" class="column frame-1-c"><div id="frameHHPy8P_left_temp" class="move-span temp"></div><?php block_display('3029');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameM3peeN" class=" frame move-span cl frame-1"><div id="frameM3peeN_left" class="column frame-1-c"><div id="frameM3peeN_left_temp" class="move-span temp"></div><?php block_display('3027');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framew58500" class="cl_frame_bm frame move-span cl frame-1"><div id="framew58500_left" class="column frame-1-c"><div id="framew58500_left_temp" class="move-span temp"></div><?php block_display('3018');?><?php block_display('3019');?><?php block_display('3020');?><?php block_display('3021');?><?php block_display('3022');?><?php block_display('3023');?><?php block_display('3024');?><?php block_display('3025');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameL4znri" class="frame move-span cl frame-1"><div id="frameL4znri_left" class="column frame-1-c"><div id="frameL4znri_left_temp" class="move-span temp"></div><?php block_display('3028');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
