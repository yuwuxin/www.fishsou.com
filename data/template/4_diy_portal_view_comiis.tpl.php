<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_comiis');
0
|| checktplrefresh('./template/comiis_meizhou/portal/view_comiis.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844001, 'diy', './data/template/4_diy_portal_view_comiis.tpl.php', './template/comiis_meizhou', 'portal/view_comiis')
|| checktplrefresh('./template/comiis_meizhou/portal/view_comiis.htm', './template/default/common/seccheck.htm', 1527844001, 'diy', './data/template/4_diy_portal_view_comiis.tpl.php', './template/comiis_meizhou', 'portal/view_comiis')
;?>
﻿<?php include template('common/header'); ?><!--[name]AB模板网建站-梅州社区内容页[/name]-->
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"></div><!--[/diy]-->
