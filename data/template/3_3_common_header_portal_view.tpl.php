...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1527844267, '3', './data/template/3_3_common_header_portal_view.tpl.php', './template/zvis_005', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1527844267, '3', './data/template/3_3_common_header_portal_view.tpl.php', './template/zvis_005', 'common/header_portal_view')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1527844267, '3', './data/template/3_3_common_header_portal_view.tpl.php', './template/zvis_005', 'common/header_portal_view')
;?>
