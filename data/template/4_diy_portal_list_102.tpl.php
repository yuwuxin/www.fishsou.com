<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_102');
block_get('3038,3041,3039,3030,3031,3032,3033,3034,3035,3036,3037,3040');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frametdHzWd" class="cl_frame_bm frame move-span cl frame-1"><div id="frametdHzWd_left" class="column frame-1-c"><div id="frametdHzWd_left_temp" class="move-span temp"></div><?php block_display('3038');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3031 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3033 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3035 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3038 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameuXduSR {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framekuDeC0" class="frame move-span cl frame-1"><div id="framekuDeC0_left" class="column frame-1-c"><div id="framekuDeC0_left_temp" class="move-span temp"></div><?php block_display('3041');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameuXduSR" class=" frame move-span cl frame-1"><div id="frameuXduSR_left" class="column frame-1-c"><div id="frameuXduSR_left_temp" class="move-span temp"></div><?php block_display('3039');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framexm9d89" class="cl_frame_bm frame move-span cl frame-1"><div id="framexm9d89_left" class="column frame-1-c"><div id="framexm9d89_left_temp" class="move-span temp"></div><?php block_display('3030');?><?php block_display('3031');?><?php block_display('3032');?><?php block_display('3033');?><?php block_display('3034');?><?php block_display('3035');?><?php block_display('3036');?><?php block_display('3037');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framernnia1" class="frame move-span cl frame-1"><div id="framernnia1_left" class="column frame-1-c"><div id="framernnia1_left_temp" class="move-span temp"></div><?php block_display('3040');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
