<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_84');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_84.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844602, 'diy', './data/template/4_diy_portal_view_84.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_84')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_84.htm', './template/default/common/seccheck.htm', 1527844602, 'diy', './data/template/4_diy_portal_view_84.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_84')
;
block_get('3290,3293,3291,3282,3283,3284,3285,3286,3287,3288,3289,3292');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framerZi93g" class="frame move-span cl frame-1"><div id="framerZi93g_left" class="column frame-1-c"><div id="framerZi93g_left_temp" class="move-span temp"></div></div></div><div id="framegKyVcq" class="cl_frame_bm frame move-span cl frame-1"><div id="framegKyVcq_left" class="column frame-1-c"><div id="framegKyVcq_left_temp" class="move-span temp"></div><?php block_display('3290');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3283 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3285 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3287 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3290 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framen87Stw {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="framehpuezp" class="frame move-span cl frame-1"><div id="framehpuezp_left" class="column frame-1-c"><div id="framehpuezp_left_temp" class="move-span temp"></div><?php block_display('3293');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framen87Stw" class=" frame move-span cl frame-1"><div id="framen87Stw_left" class="column frame-1-c"><div id="framen87Stw_left_temp" class="move-span temp"></div><?php block_display('3291');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameAWQGwW" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAWQGwW_left" class="column frame-1-c"><div id="frameAWQGwW_left_temp" class="move-span temp"></div><?php block_display('3282');?><?php block_display('3283');?><?php block_display('3284');?><?php block_display('3285');?><?php block_display('3286');?><?php block_display('3287');?><?php block_display('3288');?><?php block_display('3289');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameZ6eGvT" class="frame move-span cl frame-1"><div id="frameZ6eGvT_left" class="column frame-1-c"><div id="frameZ6eGvT_left_temp" class="move-span temp"></div><?php block_display('3292');?></div></div></div><!--[/diy]-->
</div>
