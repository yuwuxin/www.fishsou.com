<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_14');
block_get('1946,1949,1947,1938,1939,1940,1941,1942,1943,1944,1945,1948');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framee0vT0f" class="cl_frame_bm frame move-span cl frame-1"><div id="framee0vT0f_left" class="column frame-1-c"><div id="framee0vT0f_left_temp" class="move-span temp"></div><?php block_display('1946');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1939 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1941 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1943 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1946 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frames3iXo8 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameo2uj9o" class="frame move-span cl frame-1"><div id="frameo2uj9o_left" class="column frame-1-c"><div id="frameo2uj9o_left_temp" class="move-span temp"></div><?php block_display('1949');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frames3iXo8" class=" frame move-span cl frame-1"><div id="frames3iXo8_left" class="column frame-1-c"><div id="frames3iXo8_left_temp" class="move-span temp"></div><?php block_display('1947');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameAjT3sG" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAjT3sG_left" class="column frame-1-c"><div id="frameAjT3sG_left_temp" class="move-span temp"></div><?php block_display('1938');?><?php block_display('1939');?><?php block_display('1940');?><?php block_display('1941');?><?php block_display('1942');?><?php block_display('1943');?><?php block_display('1944');?><?php block_display('1945');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameRoMn7A" class="frame move-span cl frame-1"><div id="frameRoMn7A_left" class="column frame-1-c"><div id="frameRoMn7A_left_temp" class="move-span temp"></div><?php block_display('1948');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
