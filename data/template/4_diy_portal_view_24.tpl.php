<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_24');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_24.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527889495, 'diy', './data/template/4_diy_portal_view_24.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_24')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_24.htm', './template/default/common/seccheck.htm', 1527889495, 'diy', './data/template/4_diy_portal_view_24.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_24')
;
block_get('3182,3185,3183,3174,3175,3176,3177,3178,3179,3180,3181,3184');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameB4ftmT" class="frame move-span cl frame-1"><div id="frameB4ftmT_left" class="column frame-1-c"><div id="frameB4ftmT_left_temp" class="move-span temp"></div></div></div><div id="frameU7bOVo" class="cl_frame_bm frame move-span cl frame-1"><div id="frameU7bOVo_left" class="column frame-1-c"><div id="frameU7bOVo_left_temp" class="move-span temp"></div><?php block_display('3182');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3175 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3177 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3179 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3182 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameAH8ew9 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameBFZBHL" class="frame move-span cl frame-1"><div id="frameBFZBHL_left" class="column frame-1-c"><div id="frameBFZBHL_left_temp" class="move-span temp"></div><?php block_display('3185');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameAH8ew9" class=" frame move-span cl frame-1"><div id="frameAH8ew9_left" class="column frame-1-c"><div id="frameAH8ew9_left_temp" class="move-span temp"></div><?php block_display('3183');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framev0Q0xB" class="cl_frame_bm frame move-span cl frame-1"><div id="framev0Q0xB_left" class="column frame-1-c"><div id="framev0Q0xB_left_temp" class="move-span temp"></div><?php block_display('3174');?><?php block_display('3175');?><?php block_display('3176');?><?php block_display('3177');?><?php block_display('3178');?><?php block_display('3179');?><?php block_display('3180');?><?php block_display('3181');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frametCxwaa" class="frame move-span cl frame-1"><div id="frametCxwaa_left" class="column frame-1-c"><div id="frametCxwaa_left_temp" class="move-span temp"></div><?php block_display('3184');?></div></div></div><!--[/diy]-->
</div>
