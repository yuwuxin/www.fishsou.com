<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_42');
block_get('2690,2693,2691,2682,2683,2684,2685,2686,2687,2688,2689,2692');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameFfw0TT" class="cl_frame_bm frame move-span cl frame-1"><div id="frameFfw0TT_left" class="column frame-1-c"><div id="frameFfw0TT_left_temp" class="move-span temp"></div><?php block_display('2690');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2683 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2685 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2687 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2690 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameFukb3w {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framelx1oTf" class="frame move-span cl frame-1"><div id="framelx1oTf_left" class="column frame-1-c"><div id="framelx1oTf_left_temp" class="move-span temp"></div><?php block_display('2693');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameFukb3w" class=" frame move-span cl frame-1"><div id="frameFukb3w_left" class="column frame-1-c"><div id="frameFukb3w_left_temp" class="move-span temp"></div><?php block_display('2691');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameexZnlN" class="cl_frame_bm frame move-span cl frame-1"><div id="frameexZnlN_left" class="column frame-1-c"><div id="frameexZnlN_left_temp" class="move-span temp"></div><?php block_display('2682');?><?php block_display('2683');?><?php block_display('2684');?><?php block_display('2685');?><?php block_display('2686');?><?php block_display('2687');?><?php block_display('2688');?><?php block_display('2689');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framehw7FWw" class="frame move-span cl frame-1"><div id="framehw7FWw_left" class="column frame-1-c"><div id="framehw7FWw_left_temp" class="move-span temp"></div><?php block_display('2692');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
