<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_31');
block_get('2426,2429,2427,2418,2419,2420,2421,2422,2423,2424,2425,2428');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framec08QQQ" class="cl_frame_bm frame move-span cl frame-1"><div id="framec08QQQ_left" class="column frame-1-c"><div id="framec08QQQ_left_temp" class="move-span temp"></div><?php block_display('2426');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2419 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2421 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2423 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2426 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framenZp92x {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framenscV6D" class="frame move-span cl frame-1"><div id="framenscV6D_left" class="column frame-1-c"><div id="framenscV6D_left_temp" class="move-span temp"></div><?php block_display('2429');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framenZp92x" class=" frame move-span cl frame-1"><div id="framenZp92x_left" class="column frame-1-c"><div id="framenZp92x_left_temp" class="move-span temp"></div><?php block_display('2427');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framePMwmLl" class="cl_frame_bm frame move-span cl frame-1"><div id="framePMwmLl_left" class="column frame-1-c"><div id="framePMwmLl_left_temp" class="move-span temp"></div><?php block_display('2418');?><?php block_display('2419');?><?php block_display('2420');?><?php block_display('2421');?><?php block_display('2422');?><?php block_display('2423');?><?php block_display('2424');?><?php block_display('2425');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameDFGsgA" class="frame move-span cl frame-1"><div id="frameDFGsgA_left" class="column frame-1-c"><div id="frameDFGsgA_left_temp" class="move-span temp"></div><?php block_display('2428');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
