...
block_get('3387,3386,3378,3380,3381,3382,3383,3384,3385,3379');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<style id="diy_style" type="text/css">#portal_block_3387 {  margin:0px !important;}</style>
<?php if(empty($gid)) { ?>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framep1jj1g" class="cl_frame_bm frame move-span cl frame-1"><div id="framep1jj1g_left" class="column frame-1-c"><div id="framep1jj1g_left_temp" class="move-span temp"></div><?php block_display('3387');?><?php block_display('3386');?></div></div></div><!--[/diy]-->
</div>
<?php } if($comiis_forum_ng==1) { ?>
<div class="wp comiis_bbsbox">
<div class="comiis_bbsbox_z">
<!--[diy=comiis_bbsbox_swf]--><div id="comiis_bbsbox_swf" class="area"><div id="frameSmz4ET" class="cl_frame_bm frame move-span cl frame-1"><div id="frameSmz4ET_left" class="column frame-1-c"><div id="frameSmz4ET_left_temp" class="move-span temp"></div><?php block_display('3378');?></div></div></div><!--[/diy]-->
</div>
<div class="comiis_bbsbox_y">
<div class="comiis_bbsbox_tab cl">
<ul>
<li class="kmon" id="comiis_btab_1" onMouseOver="switchTab('comiis_btab',1,5,'kmon');"><a href="javascript:;">推荐帖子</a></li>
<li id="comiis_btab_2" onMouseOver="switchTab('comiis_btab',2,5,'kmon');"><a href="forum.php?mod=guide&amp;view=newthread" target="_blank">最新发表</a></li>
<li id="comiis_btab_3" onMouseOver="switchTab('comiis_btab',3,5,'kmon');"><a href="forum.php?mod=guide&amp;view=new" target="_blank">最新回复</a></li>
<li id="comiis_btab_4" onMouseOver="switchTab('comiis_btab',4,5,'kmon');"><a href="forum.php?mod=guide&amp;view=hot" target="_blank">热门帖子</a></li>
<li id="comiis_btab_5" onMouseOver="switchTab('comiis_btab',5,5,'kmon');"><a href="http://www.adminbuy.cn" target="_blank">社区活动</a></li>
</ul>
</div>
<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_1">
<!--[diy=comiis_bbsbox_01]--><div id="comiis_bbsbox_01" class="area"><div id="framepaXjJJ" class="cl_frame_bm frame move-span cl frame-1"><div id="framepaXjJJ_left" class="column frame-1-c"><div id="framepaXjJJ_left_temp" class="move-span temp"></div><?php block_display('3380');?><?php block_display('3381');?></div></div></div><!--[/diy]-->
</div>
<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_2" style="display:none">
<!--[diy=comiis_bbsbox_02]--><div id="comiis_bbsbox_02" class="area"><div id="frameyl20bS" class="cl_frame_bm frame move-span cl frame-1"><div id="frameyl20bS_left" class="column frame-1-c"><div id="frameyl20bS_left_temp" class="move-span temp"></div><?php block_display('3382');?></div></div></div><!--[/diy]-->
</div>
<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_3" style="display:none">
<!--[diy=comiis_bbsbox_03]--><div id="comiis_bbsbox_03" class="area"><div id="frameHj45Vj" class="cl_frame_bm frame move-span cl frame-1"><div id="frameHj45Vj_left" class="column frame-1-c"><div id="frameHj45Vj_left_temp" class="move-span temp"></div><?php block_display('3383');?></div></div></div><!--[/diy]-->
</div>
<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_4" style="display:none">
<!--[diy=comiis_bbsbox_04]--><div id="comiis_bbsbox_04" class="area"><div id="frameOrMKPw" class="cl_frame_bm frame move-span cl frame-1"><div id="frameOrMKPw_left" class="column frame-1-c"><div id="frameOrMKPw_left_temp" class="move-span temp"></div><?php block_display('3384');?></div></div></div><!--[/diy]-->
</div>
<div class="comiis_bbsbox_tabli cl" id="comiis_btab_c_5" style="display:none">
<!--[diy=comiis_bbsbox_05]--><div id="comiis_bbsbox_05" class="area"><div id="frameusyHS6" class="cl_frame_bm frame move-span cl frame-1"><div id="frameusyHS6_left" class="column frame-1-c"><div id="frameusyHS6_left_temp" class="move-span temp"></div><?php block_display('3385');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<!--[diy=comiis_ngdiy]--><div id="comiis_ngdiy" class="area"></div><!--[/diy]-->
<?php } ?>
...
<div class="y comiis_chart_btn">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<a href="forum.php?mod=guide&amp;view=newthread" target="_blank" title="查看新帖">查看新帖</a>
<?php if(!empty($_G['setting']['search']['forum']['status'])) { ?><a href="forum.php?mod=guide&amp;view=new" title="最新回复">最新回复</a><?php } ?>
<a href="forum.php?mod=guide&amp;view=hot" target="_blank" title="热门帖子">热门帖子</a>
<a href="forum.php?mod=guide&amp;view=newthread" target="_blank" title="帖子汇总" >帖子汇总</a>
</div>
</div>
<?php } ?>
<!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]-->
<div class="mn viab" style="margin-bottom:0;">
...
<div class="module cl slidebox_grid" style="width:<?php if($comiis_window_width==1) { ?>275px<?php } else { ?>225px<?php } ?>">
<script type="text/javascript">
var slideSpeed = 5000;
var slideImgsize = [<?php if($comiis_window_width==1) { ?>275<?php } else { ?>225<?php } ?>,235];
...
<td valign="top" class="category_l3<?php if(!$_G['setting']['grid']['gridtype']) { ?> category_l3hot<?php } ?>">
<div class="hottiebox">
...
<div class="wp mtn">
<!--[diy=diy3]--><div id="diy3" class="area"><div id="frameIbbGu7" class="cl_frame_bm frame move-span cl frame-1"><div id="frameIbbGu7_left" class="column frame-1-c"><div id="frameIbbGu7_left_temp" class="move-span temp"></div><?php block_display('3379');?></div></div></div><!--[/diy]-->
</div>
...
<div class="bm lk" style="margin-bottom:0;">
<div class="bm_h cl">
<h2>友情链接</h2>
</div>
