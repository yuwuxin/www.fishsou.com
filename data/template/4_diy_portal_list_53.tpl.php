<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_53');
block_get('2822,2825,2823,2814,2815,2816,2817,2818,2819,2820,2821,2824');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameAKcMTy" class="cl_frame_bm frame move-span cl frame-1"><div id="frameAKcMTy_left" class="column frame-1-c"><div id="frameAKcMTy_left_temp" class="move-span temp"></div><?php block_display('2822');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2815 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2817 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2819 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2822 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameX4hh8n {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framej66mpK" class="frame move-span cl frame-1"><div id="framej66mpK_left" class="column frame-1-c"><div id="framej66mpK_left_temp" class="move-span temp"></div><?php block_display('2825');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameX4hh8n" class=" frame move-span cl frame-1"><div id="frameX4hh8n_left" class="column frame-1-c"><div id="frameX4hh8n_left_temp" class="move-span temp"></div><?php block_display('2823');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framek6gIkK" class="cl_frame_bm frame move-span cl frame-1"><div id="framek6gIkK_left" class="column frame-1-c"><div id="framek6gIkK_left_temp" class="move-span temp"></div><?php block_display('2814');?><?php block_display('2815');?><?php block_display('2816');?><?php block_display('2817');?><?php block_display('2818');?><?php block_display('2819');?><?php block_display('2820');?><?php block_display('2821');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameqKHXKK" class="frame move-span cl frame-1"><div id="frameqKHXKK_left" class="column frame-1-c"><div id="frameqKHXKK_left_temp" class="move-span temp"></div><?php block_display('2824');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
