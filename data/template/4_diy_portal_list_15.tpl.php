<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_15');
block_get('1958,1961,1959,1950,1951,1952,1953,1954,1955,1956,1957,1960');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framelASfzK" class="cl_frame_bm frame move-span cl frame-1"><div id="framelASfzK_left" class="column frame-1-c"><div id="framelASfzK_left_temp" class="move-span temp"></div><?php block_display('1958');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1951 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1953 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1955 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1958 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameyR000p {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameByeie1" class="frame move-span cl frame-1"><div id="frameByeie1_left" class="column frame-1-c"><div id="frameByeie1_left_temp" class="move-span temp"></div><?php block_display('1961');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameyR000p" class=" frame move-span cl frame-1"><div id="frameyR000p_left" class="column frame-1-c"><div id="frameyR000p_left_temp" class="move-span temp"></div><?php block_display('1959');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameXHtRp7" class="cl_frame_bm frame move-span cl frame-1"><div id="frameXHtRp7_left" class="column frame-1-c"><div id="frameXHtRp7_left_temp" class="move-span temp"></div><?php block_display('1950');?><?php block_display('1951');?><?php block_display('1952');?><?php block_display('1953');?><?php block_display('1954');?><?php block_display('1955');?><?php block_display('1956');?><?php block_display('1957');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameNc0kZG" class="frame move-span cl frame-1"><div id="frameNc0kZG_left" class="column frame-1-c"><div id="frameNc0kZG_left_temp" class="move-span temp"></div><?php block_display('1960');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
