<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_30');
block_get('2414,2417,2415,2406,2407,2408,2409,2410,2411,2412,2413,2416');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framefWxxzx" class="cl_frame_bm frame move-span cl frame-1"><div id="framefWxxzx_left" class="column frame-1-c"><div id="framefWxxzx_left_temp" class="move-span temp"></div><?php block_display('2414');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2407 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2409 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2411 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2414 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameZ9bRY4 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framew6imZ6" class="frame move-span cl frame-1"><div id="framew6imZ6_left" class="column frame-1-c"><div id="framew6imZ6_left_temp" class="move-span temp"></div><?php block_display('2417');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameZ9bRY4" class=" frame move-span cl frame-1"><div id="frameZ9bRY4_left" class="column frame-1-c"><div id="frameZ9bRY4_left_temp" class="move-span temp"></div><?php block_display('2415');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameRRtQTq" class="cl_frame_bm frame move-span cl frame-1"><div id="frameRRtQTq_left" class="column frame-1-c"><div id="frameRRtQTq_left_temp" class="move-span temp"></div><?php block_display('2406');?><?php block_display('2407');?><?php block_display('2408');?><?php block_display('2409');?><?php block_display('2410');?><?php block_display('2411');?><?php block_display('2412');?><?php block_display('2413');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameGb9rL7" class="frame move-span cl frame-1"><div id="frameGb9rL7_left" class="column frame-1-c"><div id="frameGb9rL7_left_temp" class="move-span temp"></div><?php block_display('2416');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
