<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_82');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_82.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527845623, 'diy', './data/template/4_diy_portal_view_82.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_82')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_82.htm', './template/default/common/seccheck.htm', 1527845623, 'diy', './data/template/4_diy_portal_view_82.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_82')
;
block_get('3266,3269,3267,3258,3259,3260,3261,3262,3263,3264,3265,3268');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framezVLJBI" class="frame move-span cl frame-1"><div id="framezVLJBI_left" class="column frame-1-c"><div id="framezVLJBI_left_temp" class="move-span temp"></div></div></div><div id="frameNuElf3" class="cl_frame_bm frame move-span cl frame-1"><div id="frameNuElf3_left" class="column frame-1-c"><div id="frameNuElf3_left_temp" class="move-span temp"></div><?php block_display('3266');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3259 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3261 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3263 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3266 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framezDiRlh {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="framepZgwoB" class="frame move-span cl frame-1"><div id="framepZgwoB_left" class="column frame-1-c"><div id="framepZgwoB_left_temp" class="move-span temp"></div><?php block_display('3269');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framezDiRlh" class=" frame move-span cl frame-1"><div id="framezDiRlh_left" class="column frame-1-c"><div id="framezDiRlh_left_temp" class="move-span temp"></div><?php block_display('3267');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameUkM73V" class="cl_frame_bm frame move-span cl frame-1"><div id="frameUkM73V_left" class="column frame-1-c"><div id="frameUkM73V_left_temp" class="move-span temp"></div><?php block_display('3258');?><?php block_display('3259');?><?php block_display('3260');?><?php block_display('3261');?><?php block_display('3262');?><?php block_display('3263');?><?php block_display('3264');?><?php block_display('3265');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameUN44WC" class="frame move-span cl frame-1"><div id="frameUN44WC_left" class="column frame-1-c"><div id="frameUN44WC_left_temp" class="move-span temp"></div><?php block_display('3268');?></div></div></div><!--[/diy]-->
</div>
