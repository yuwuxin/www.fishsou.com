<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_16');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_16.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844295, 'diy', './data/template/4_diy_portal_view_16.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_16')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_16.htm', './template/default/common/seccheck.htm', 1527844295, 'diy', './data/template/4_diy_portal_view_16.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_16')
;
block_get('1797,1789,1790,1791,1792,1793,1794,1795,1796');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framehJm26G" class="cl_frame_bm frame move-span cl frame-1"><div id="framehJm26G_left" class="column frame-1-c"><div id="framehJm26G_left_temp" class="move-span temp"></div><?php block_display('1797');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1790 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1792 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1794 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1797 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}</style>
<div class="wp">
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framep45WZf" class="cl_frame_bm frame move-span cl frame-1"><div id="framep45WZf_left" class="column frame-1-c"><div id="framep45WZf_left_temp" class="move-span temp"></div><?php block_display('1789');?><?php block_display('1790');?><?php block_display('1791');?><?php block_display('1792');?><?php block_display('1793');?><?php block_display('1794');?><?php block_display('1795');?><?php block_display('1796');?></div></div></div><!--[/diy]-->
<div class="drag">
