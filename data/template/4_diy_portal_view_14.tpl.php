<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_14');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_14.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844220, 'diy', './data/template/4_diy_portal_view_14.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_14')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_14.htm', './template/default/common/seccheck.htm', 1527844220, 'diy', './data/template/4_diy_portal_view_14.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_14')
;
block_get('3050,3053,3051,3042,3043,3044,3045,3046,3047,3048,3049,3052');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameY6dp6i" class="frame move-span cl frame-1"><div id="frameY6dp6i_left" class="column frame-1-c"><div id="frameY6dp6i_left_temp" class="move-span temp"></div></div></div><div id="frameiPxXB4" class="cl_frame_bm frame move-span cl frame-1"><div id="frameiPxXB4_left" class="column frame-1-c"><div id="frameiPxXB4_left_temp" class="move-span temp"></div><?php block_display('3050');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3043 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3045 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3047 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3050 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameCM4y4I {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameiQ3Q14" class="frame move-span cl frame-1"><div id="frameiQ3Q14_left" class="column frame-1-c"><div id="frameiQ3Q14_left_temp" class="move-span temp"></div><?php block_display('3053');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameCM4y4I" class=" frame move-span cl frame-1"><div id="frameCM4y4I_left" class="column frame-1-c"><div id="frameCM4y4I_left_temp" class="move-span temp"></div><?php block_display('3051');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framey0oOJU" class="cl_frame_bm frame move-span cl frame-1"><div id="framey0oOJU_left" class="column frame-1-c"><div id="framey0oOJU_left_temp" class="move-span temp"></div><?php block_display('3042');?><?php block_display('3043');?><?php block_display('3044');?><?php block_display('3045');?><?php block_display('3046');?><?php block_display('3047');?><?php block_display('3048');?><?php block_display('3049');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameR9VK8V" class="frame move-span cl frame-1"><div id="frameR9VK8V_left" class="column frame-1-c"><div id="frameR9VK8V_left_temp" class="move-span temp"></div><?php block_display('3052');?></div></div></div><!--[/diy]-->
</div>
