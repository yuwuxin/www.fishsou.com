<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_43');
block_get('2702,2705,2703,2694,2695,2696,2697,2698,2699,2700,2701,2704');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framec82YN5" class="cl_frame_bm frame move-span cl frame-1"><div id="framec82YN5_left" class="column frame-1-c"><div id="framec82YN5_left_temp" class="move-span temp"></div><?php block_display('2702');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2695 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2697 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2699 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2702 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framelOrcb2 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameR4z4b7" class="frame move-span cl frame-1"><div id="frameR4z4b7_left" class="column frame-1-c"><div id="frameR4z4b7_left_temp" class="move-span temp"></div><?php block_display('2705');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framelOrcb2" class=" frame move-span cl frame-1"><div id="framelOrcb2_left" class="column frame-1-c"><div id="framelOrcb2_left_temp" class="move-span temp"></div><?php block_display('2703');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameq6N6m1" class="cl_frame_bm frame move-span cl frame-1"><div id="frameq6N6m1_left" class="column frame-1-c"><div id="frameq6N6m1_left_temp" class="move-span temp"></div><?php block_display('2694');?><?php block_display('2695');?><?php block_display('2696');?><?php block_display('2697');?><?php block_display('2698');?><?php block_display('2699');?><?php block_display('2700');?><?php block_display('2701');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framec1ffVp" class="frame move-span cl frame-1"><div id="framec1ffVp_left" class="column frame-1-c"><div id="framec1ffVp_left_temp" class="move-span temp"></div><?php block_display('2704');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
