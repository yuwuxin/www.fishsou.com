...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1527863592, '4', './data/template/4_4_member_login.tpl.php', './template/comiis_meizhou', 'member/login')
