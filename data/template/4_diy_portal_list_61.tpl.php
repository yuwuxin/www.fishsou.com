<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_61');
block_get('2918,2921,2919,2910,2911,2912,2913,2914,2915,2916,2917,2920');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameFNuR34" class="cl_frame_bm frame move-span cl frame-1"><div id="frameFNuR34_left" class="column frame-1-c"><div id="frameFNuR34_left_temp" class="move-span temp"></div><?php block_display('2918');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2911 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2913 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2915 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2918 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameczYEaY {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameHlZlO5" class="frame move-span cl frame-1"><div id="frameHlZlO5_left" class="column frame-1-c"><div id="frameHlZlO5_left_temp" class="move-span temp"></div><?php block_display('2921');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameczYEaY" class=" frame move-span cl frame-1"><div id="frameczYEaY_left" class="column frame-1-c"><div id="frameczYEaY_left_temp" class="move-span temp"></div><?php block_display('2919');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framedzWhff" class="cl_frame_bm frame move-span cl frame-1"><div id="framedzWhff_left" class="column frame-1-c"><div id="framedzWhff_left_temp" class="move-span temp"></div><?php block_display('2910');?><?php block_display('2911');?><?php block_display('2912');?><?php block_display('2913');?><?php block_display('2914');?><?php block_display('2915');?><?php block_display('2916');?><?php block_display('2917');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framedhH5aL" class="frame move-span cl frame-1"><div id="framedhH5aL_left" class="column frame-1-c"><div id="framedhH5aL_left_temp" class="move-span temp"></div><?php block_display('2920');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
