<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_15');
0
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_15.htm', './template/comiis_meizhou/portal/portal_comment.htm', 1527844142, 'diy', './data/template/4_diy_portal_view_15.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_15')
|| checktplrefresh('data/diy/./template/comiis_meizhou//portal/view_15.htm', './template/default/common/seccheck.htm', 1527844142, 'diy', './data/template/4_diy_portal_view_15.tpl.php', 'data/diy/./template/comiis_meizhou/', 'portal/view_15')
;
block_get('3062,3065,3063,3054,3055,3056,3057,3058,3059,3060,3061,3064');?>
...
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['view_article_top'])) echo $_G['setting']['pluginhooks']['view_article_top'];?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framenAMoMI" class="frame move-span cl frame-1"><div id="framenAMoMI_left" class="column frame-1-c"><div id="framenAMoMI_left_temp" class="move-span temp"></div></div></div><div id="framex7yGyG" class="cl_frame_bm frame move-span cl frame-1"><div id="framex7yGyG_left" class="column frame-1-c"><div id="framex7yGyG_left_temp" class="move-span temp"></div><?php block_display('3062');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3055 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3057 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3059 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3062 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameVhqGHS {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=diysummarybottom]--><div id="diysummarybottom" class="area"><div id="frameH4a2e2" class="frame move-span cl frame-1"><div id="frameH4a2e2_left" class="column frame-1-c"><div id="frameH4a2e2_left_temp" class="move-span temp"></div><?php block_display('3065');?></div></div></div><!--[/diy]-->
<div class="d">
...
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameVhqGHS" class=" frame move-span cl frame-1"><div id="frameVhqGHS_left" class="column frame-1-c"><div id="frameVhqGHS_left_temp" class="move-span temp"></div><?php block_display('3063');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameNh0ogj" class="cl_frame_bm frame move-span cl frame-1"><div id="frameNh0ogj_left" class="column frame-1-c"><div id="frameNh0ogj_left_temp" class="move-span temp"></div><?php block_display('3054');?><?php block_display('3055');?><?php block_display('3056');?><?php block_display('3057');?><?php block_display('3058');?><?php block_display('3059');?><?php block_display('3060');?><?php block_display('3061');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameEWkTb4" class="frame move-span cl frame-1"><div id="frameEWkTb4_left" class="column frame-1-c"><div id="frameEWkTb4_left_temp" class="move-span temp"></div><?php block_display('3064');?></div></div></div><!--[/diy]-->
</div>
