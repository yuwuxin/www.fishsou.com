<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_36');
block_get('2486,2489,2487,2478,2479,2480,2481,2482,2483,2484,2485,2488');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameaMVAMz" class="cl_frame_bm frame move-span cl frame-1"><div id="frameaMVAMz_left" class="column frame-1-c"><div id="frameaMVAMz_left_temp" class="move-span temp"></div><?php block_display('2486');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2479 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2481 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2483 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2486 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameM5enE8 {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framecB6B5v" class="frame move-span cl frame-1"><div id="framecB6B5v_left" class="column frame-1-c"><div id="framecB6B5v_left_temp" class="move-span temp"></div><?php block_display('2489');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameM5enE8" class=" frame move-span cl frame-1"><div id="frameM5enE8_left" class="column frame-1-c"><div id="frameM5enE8_left_temp" class="move-span temp"></div><?php block_display('2487');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameryHhR3" class="cl_frame_bm frame move-span cl frame-1"><div id="frameryHhR3_left" class="column frame-1-c"><div id="frameryHhR3_left_temp" class="move-span temp"></div><?php block_display('2478');?><?php block_display('2479');?><?php block_display('2480');?><?php block_display('2481');?><?php block_display('2482');?><?php block_display('2483');?><?php block_display('2484');?><?php block_display('2485');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameSOvhx9" class="frame move-span cl frame-1"><div id="frameSOvhx9_left" class="column frame-1-c"><div id="frameSOvhx9_left_temp" class="move-span temp"></div><?php block_display('2488');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
