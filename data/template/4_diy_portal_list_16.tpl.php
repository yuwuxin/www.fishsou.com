<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_16');
block_get('3077,3074,3075,3066,3067,3068,3069,3070,3071,3072,3073,3076');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framenZGZJU" class="frame move-span cl frame-1"><div id="framenZGZJU_left" class="column frame-1-c"><div id="framenZGZJU_left_temp" class="move-span temp"></div><?php block_display('3077');?></div></div><div id="frameF7amDk" class="frame move-span cl frame-1"><div id="frameF7amDk_left" class="column frame-1-c"><div id="frameF7amDk_left_temp" class="move-span temp"></div></div></div><div id="framefRRF7l" class="cl_frame_bm frame move-span cl frame-1"><div id="framefRRF7l_left" class="column frame-1-c"><div id="framefRRF7l_left_temp" class="move-span temp"></div><?php block_display('3074');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3067 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3069 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3071 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3074 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameRDTVFf {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameRDTVFf" class=" frame move-span cl frame-1"><div id="frameRDTVFf_left" class="column frame-1-c"><div id="frameRDTVFf_left_temp" class="move-span temp"></div><?php block_display('3075');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framen1uWJF" class="cl_frame_bm frame move-span cl frame-1"><div id="framen1uWJF_left" class="column frame-1-c"><div id="framen1uWJF_left_temp" class="move-span temp"></div><?php block_display('3066');?><?php block_display('3067');?><?php block_display('3068');?><?php block_display('3069');?><?php block_display('3070');?><?php block_display('3071');?><?php block_display('3072');?><?php block_display('3073');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameA1Py81" class="frame move-span cl frame-1"><div id="frameA1Py81_left" class="column frame-1-c"><div id="frameA1Py81_left_temp" class="move-span temp"></div><?php block_display('3076');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
