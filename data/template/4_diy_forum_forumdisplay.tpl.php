...
0
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/comiis_meizhou/forum/forumdisplay_list.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
|| checktplrefresh('./template/comiis_meizhou/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1527845016, 'diy', './data/template/4_diy_forum_forumdisplay.tpl.php', './template/comiis_meizhou', 'forum/forumdisplay')
;?><?php include template('common/header'); if(!(empty($_G['forum']['picstyle']) || $_G['cookie']['forumdefstyle']) && $comiis_list_image) { $leftside=0;$comiis_list_zlb=0;?><?php } if($_G['forum']['ismoderator']) { ?>
...
<div class="bm_c"<?php if(!(empty($_G['forum']['picstyle']) || $_G['cookie']['forumdefstyle'])) { ?> style="padding:0px 0px 0px 12px;"<?php } ?>>
...
<tr<?php if($key%2==0) { ?> bgcolor="#f7f7f7"<?php } ?>>
<td class="icn">
...
<?php if($comiis_list_face==1) { ?><span class="comiis_lyhtx"><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>"><?php echo avatar($thread[authorid],small);?></a></span><?php } ?>
<cite>
...
<DIV class="comiis_l190">
  <div class="list_left"<?php if($comiis_list_zlb_tx==0) { ?> style="padding-top:7px;"<?php } ?>>
<?php if($comiis_list_zlb_tx==1) { ?>
    <div class="widget left_nav" style="border-top:0px solid #DDDDDD;">
      <ul style="margin:0 8px 10px;">
        <li class="km_icon icon_top"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['cache']['forums'][$_G['forum']['fup']]['fid'];?>"><?php echo $_G['cache']['forums'][$_G['forum']['fup']]['name'];?></a></li>
        <?php $comiis_nn=0;?>        <?php if(is_array($_G['cache']['forums'])) foreach($_G['cache']['forums'] as $comiis_f) { if($comiis_f['status'] && $comiis_f['fup'] == $_G['forum']['fup']) { $comiis_nn++;?><li<?php if($comiis_f['fid']==$_G['forum']['fid']) { ?> class="select"<?php } ?>><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $comiis_f['fid'];?>"><?php echo $comiis_nn;?>F:<?php echo $comiis_f['name'];?></a></li>
<?php } ?>
        <?php } ?>
      </ul>
    </div>
