<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_11');
block_get('1910,1913,1911,1902,1903,1904,1905,1906,1907,1908,1909,1912');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framecBum88" class="cl_frame_bm frame move-span cl frame-1"><div id="framecBum88_left" class="column frame-1-c"><div id="framecBum88_left_temp" class="move-span temp"></div><?php block_display('1910');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_1903 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1905 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_1907 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_1910 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#framez0vFnv {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framem0qV44" class="frame move-span cl frame-1"><div id="framem0qV44_left" class="column frame-1-c"><div id="framem0qV44_left_temp" class="move-span temp"></div><?php block_display('1913');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="framez0vFnv" class=" frame move-span cl frame-1"><div id="framez0vFnv_left" class="column frame-1-c"><div id="framez0vFnv_left_temp" class="move-span temp"></div><?php block_display('1911');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framekpNc1v" class="cl_frame_bm frame move-span cl frame-1"><div id="framekpNc1v_left" class="column frame-1-c"><div id="framekpNc1v_left_temp" class="move-span temp"></div><?php block_display('1902');?><?php block_display('1903');?><?php block_display('1904');?><?php block_display('1905');?><?php block_display('1906');?><?php block_display('1907');?><?php block_display('1908');?><?php block_display('1909');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="framediwptt" class="frame move-span cl frame-1"><div id="framediwptt_left" class="column frame-1-c"><div id="framediwptt_left_temp" class="move-span temp"></div><?php block_display('1912');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
