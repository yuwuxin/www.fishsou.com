<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_86');
block_get('3326,3329,3327,3318,3319,3320,3321,3322,3323,3324,3325,3328');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="framehSS4SU" class="cl_frame_bm frame move-span cl frame-1"><div id="framehSS4SU_left" class="column frame-1-c"><div id="framehSS4SU_left_temp" class="move-span temp"></div><?php block_display('3326');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_3319 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3321 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_3323 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_3326 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameL3yg4Y {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameR9lch7" class="frame move-span cl frame-1"><div id="frameR9lch7_left" class="column frame-1-c"><div id="frameR9lch7_left_temp" class="move-span temp"></div><?php block_display('3329');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameL3yg4Y" class=" frame move-span cl frame-1"><div id="frameL3yg4Y_left" class="column frame-1-c"><div id="frameL3yg4Y_left_temp" class="move-span temp"></div><?php block_display('3327');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameMcTGts" class="cl_frame_bm frame move-span cl frame-1"><div id="frameMcTGts_left" class="column frame-1-c"><div id="frameMcTGts_left_temp" class="move-span temp"></div><?php block_display('3318');?><?php block_display('3319');?><?php block_display('3320');?><?php block_display('3321');?><?php block_display('3322');?><?php block_display('3323');?><?php block_display('3324');?><?php block_display('3325');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameY8Vvhc" class="frame move-span cl frame-1"><div id="frameY8Vvhc_left" class="column frame-1-c"><div id="frameY8Vvhc_left_temp" class="move-span temp"></div><?php block_display('3328');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
