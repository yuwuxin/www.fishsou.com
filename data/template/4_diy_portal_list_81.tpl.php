<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_81');
block_get('2222,2225,2223,2214,2215,2216,2217,2218,2219,2220,2221,2224');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameEhZLSi" class="cl_frame_bm frame move-span cl frame-1"><div id="frameEhZLSi_left" class="column frame-1-c"><div id="frameEhZLSi_left_temp" class="move-span temp"></div><?php block_display('2222');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2215 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2217 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2219 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2222 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameimnp3n {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="frameeWKs5Z" class="frame move-span cl frame-1"><div id="frameeWKs5Z_left" class="column frame-1-c"><div id="frameeWKs5Z_left_temp" class="move-span temp"></div><?php block_display('2225');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameimnp3n" class=" frame move-span cl frame-1"><div id="frameimnp3n_left" class="column frame-1-c"><div id="frameimnp3n_left_temp" class="move-span temp"></div><?php block_display('2223');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="framezYAt8z" class="cl_frame_bm frame move-span cl frame-1"><div id="framezYAt8z_left" class="column frame-1-c"><div id="framezYAt8z_left_temp" class="move-span temp"></div><?php block_display('2214');?><?php block_display('2215');?><?php block_display('2216');?><?php block_display('2217');?><?php block_display('2218');?><?php block_display('2219');?><?php block_display('2220');?><?php block_display('2221');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameLi69iV" class="frame move-span cl frame-1"><div id="frameLi69iV_left" class="column frame-1-c"><div id="frameLi69iV_left_temp" class="move-span temp"></div><?php block_display('2224');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
