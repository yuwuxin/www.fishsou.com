<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_88');
block_get('2306,2309,2307,2298,2299,2300,2301,2302,2303,2304,2305,2308');?>
...
<?php } ?><?php echo adshow("text/wp a_t");?><!--[diy=comiis_wz_topad]--><div id="comiis_wz_topad" class="area"><div id="frameGqmrQA" class="cl_frame_bm frame move-span cl frame-1"><div id="frameGqmrQA_left" class="column frame-1-c"><div id="frameGqmrQA_left_temp" class="move-span temp"></div><?php block_display('2306');?></div></div></div><!--[/diy]-->
...
<?php } ?>
<style id="diy_style" type="text/css">#portal_block_2299 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2301 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:15px !important;margin-left:0px !important;}#portal_block_2303 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:5px !important;margin-left:0px !important;}#portal_block_2306 {  margin-top:0px !important;margin-right:0px !important;margin-bottom:10px !important;margin-left:0px !important;}#frameI1pR1r {  margin-bottom:10px !important;}</style>
<div class="wp">
...
<!--[diy=listloopbottom]--><div id="listloopbottom" class="area"><div id="framerALQUi" class="frame move-span cl frame-1"><div id="framerALQUi_left" class="column frame-1-c"><div id="framerALQUi_left_temp" class="move-span temp"></div><?php block_display('2309');?></div></div></div><!--[/diy]-->
...
<div class="sd pph">
<div class="drag">
<!--[diy=diyrighttop]--><div id="diyrighttop" class="area"><div id="frameI1pR1r" class=" frame move-span cl frame-1"><div id="frameI1pR1r_left" class="column frame-1-c"><div id="frameI1pR1r_left_temp" class="move-span temp"></div><?php block_display('2307');?></div></div></div><!--[/diy]-->
</div>
...
<?php } ?>
<!--[diy=comiis_wz_rdiy]--><div id="comiis_wz_rdiy" class="area"><div id="frameVmVyRI" class="cl_frame_bm frame move-span cl frame-1"><div id="frameVmVyRI_left" class="column frame-1-c"><div id="frameVmVyRI_left_temp" class="move-span temp"></div><?php block_display('2298');?><?php block_display('2299');?><?php block_display('2300');?><?php block_display('2301');?><?php block_display('2302');?><?php block_display('2303');?><?php block_display('2304');?><?php block_display('2305');?></div></div></div><!--[/diy]-->
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameT11Zf2" class="frame move-span cl frame-1"><div id="frameT11Zf2_left" class="column frame-1-c"><div id="frameT11Zf2_left_temp" class="move-span temp"></div><?php block_display('2308');?></div></div></div><!--[/diy]-->
</div>
</div>
</div>
<div class="wp mtn">
